...
**What changed:**
- Added an `Alert` banner at the top of the review phase: *"The content below was extracted by AI. Please review carefully before saving."*
...
**Why:** The AI policy requires AI output to be *"visually distinct from canonical data"* and *"clearly labeled as Suggestion"*. The review cards had confidence badges but lacked explicit AI provenance labeling.

### 3. Added "AI-Extracted" Banner — `components/expenses/expense-form.tsx`

**What changed:**
- Added `Alert` banner above extracted data: *"These line items were extracted by AI. Please review amounts and categories before saving."*
