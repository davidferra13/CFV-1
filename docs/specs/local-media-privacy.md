...
The complete implementation contract, entrypoint, coverage limits and machine prerequisites are in `scripts/local-media-privacy/README.md`. Verification results belong in `docs/verification/local-media-privacy-20260908-r2.md` (current) and `docs/verification/local-media-privacy-20260908.md` (historical). No private paths, source hashes, images, catalogs or model descriptions belong in either file.
