...
3. Use `prove_yourself` as the hook: *"You said the test is [dish] — I've been thinking about how I'd do it. Want to find out?"*
4. Use `dream_menu_theme` to pitch a specific next event: *"You mentioned a full Italian spread — I have an idea for a Sunday gravy dinner."*
5. Use `obsessed_ingredient` for a seasonal outreach: *"Calabrian chili season is here and I have something in mind for you."*
