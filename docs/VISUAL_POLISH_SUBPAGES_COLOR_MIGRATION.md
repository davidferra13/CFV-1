...
**Client Portal Pages (5 files):** 14. `app/(client)/my-events/page.tsx` - gray to stone 15. `app/(client)/my-events/[id]/page.tsx` - gray to stone, blue to brand 16. `app/(client)/my-events/[id]/pay/page.tsx` - gray to stone, blue to brand 17. `app/(client)/my-quotes/page.tsx` - gray to stone, blue to brand 18. `app/(client)/my-quotes/[id]/page.tsx` - gray to stone

**Public Pages (4 files):** 19. `app/(public)/pricing/page.tsx` - gray to stone, orange to brand 20. `app/(public)/contact/page.tsx` - gray to stone, orange to brand, blue to brand 21. `app/(public)/privacy/page.tsx` - gray to stone, blue to brand 22. `app/(public)/terms/page.tsx` - gray to stone, blue to brand
