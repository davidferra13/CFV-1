...
| ---------------------------------------- | ------ | ------------- | ------ | --------------- |
| `npx tsc --noEmit --skipLibCheck`        | broken | 2026-04-30    | dirty  | Codex           |
...
| ---------- | ----- | ----- | --------------- | -------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-04-30 | broken | -     | Codex           | Culinary Radar action-lane extension. Focused Radar unit tests pass and changed-file ESLint passes. Full tsc timed out twice in this worktree after earlier known blockers from missing `@dnd-kit/*`, `@fullcalendar/*`, `@capacitor/cli`, `next-auth/jwt` `encode`, and existing implicit-any errors in auth/calendar files. |
| 2026-04-30 | broken | -     | Codex           | Culinary Radar farmers market extension. Focused Radar unit tests pass. Full tsc remains blocked by pre-existing missing `@dnd-kit/*`, `@fullcalendar/*`, `@capacitor/cli`, `next-auth/jwt` `encode`, and existing implicit-any errors in auth/calendar files. |
