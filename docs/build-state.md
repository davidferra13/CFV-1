...
| ---------------------------------------- | ------- | ------------- | --------- | --------------- |
| `npx tsc --noEmit --skipLibCheck`        | blocked | 2026-04-30    | 2604e3388 | Codex           |
...
| ---------- | ------- | ----- | --------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-04-30 | blocked | -     | Codex           | Public supporter proof unit test passed and quick regression passed. Full tsc blocked by unrelated dirty pricing proof work in `lib/pricing/geographic-proof-*`. Build not run. |
