...
### System 1: Claude Code (the lead)

- **What it is:** The primary AI engineer.
...
| From        | To          | How                                    | When                             |
| ----------- | ----------- | -------------------------------------- | -------------------------------- |
| Developer   | Claude Code | VS Code chat                           | Primary development work         |
...
from multiple OpenClaw agents, they time out. Only qwen3:4b should be used
as an OpenClaw fallback.
