...
- **`/culinary/call-sheet`** - Voice Hub for supplier and business calling. Gated by `supplier_calling`. Tabs cover Call, Call Log, Inbox, My Vendors, and Settings. The Voice Ops Control Tower sits above the tabs and summarizes active sessions, completed and failed calls, answer rate, recording coverage, urgent reviews, opt-outs, professional risk, snoozed follow-up, and next post-call actions. Persisted post-call actions are separated into failed-call recovery, active next actions, and snoozed work. Each action shows a provenance badge, inline closeout note editor, closeout controls, and a "Why this exists" evidence drawer with source webhook, ledger signals, trust checklist, duplicate guard, haptic/interruption reason when recorded, related call IDs, queued recovery intent, and snooze return window. Failed-call recovery actions expose one-click recovery queues for manual retry, SMS planning, vendor task queueing, unreachable marking, and human callback queueing. Actions can be completed, marked for review, snoozed, unsnoozed, or skipped with visible feedback. Voice boundaries remain vendor and business focused; automated outbound client calls stay blocked.
- **`/culinary/call-sheet`** - Voice Hub for supplier and business calling. Gated by `supplier_calling`. Tabs cover Call, Call Log, Inbox, My Vendors, and Settings. The Voice Ops Control Tower sits above the tabs and summarizes active sessions, completed and failed calls, answer rate, recording coverage, urgent reviews, opt-outs, professional risk, snoozed follow-up, and next post-call actions. Persisted post-call actions are separated into failed-call recovery, active next actions, and snoozed work. Each action shows a provenance badge, inline closeout note editor, closeout controls, and a "Why this exists" evidence drawer with source webhook, ledger signals, trust checklist, duplicate guard, haptic/interruption reason when recorded, related call IDs, queued recovery intent, and snooze return window. Failed-call recovery actions expose one-click recovery queues for manual retry, SMS planning, vendor task queueing, unreachable marking, and human callback queueing. Actions can be completed, marked for review, snoozed, unsnoozed, or skipped with visible feedback. Voice boundaries remain vendor and business focused; automated outbound client calls stay blocked.
