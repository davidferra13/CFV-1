...
| `/my-hub/g/[groupToken]` | Full group experience wrapped in client layout - reuses HubGroupView (7 tabs: Chat, Meals, Events, Photos, Schedule, Notes, Members). Auto-joins group, sets profile cookie. Meals tab includes weekly board, feedback, schedule changes. |
