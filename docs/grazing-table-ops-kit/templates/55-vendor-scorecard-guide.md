...
`node scripts/grazing-vendor-scorecard.mjs --input docs/grazing-table-ops-kit/spreadsheets/vendor-scorecard-entries.csv --out docs/grazing-table-ops-kit/spreadsheets/vendor-scorecard-summary.csv`
