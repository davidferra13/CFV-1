# ChefFlow Chef Portal - Complete Page & Tab Index

> Every single page, tab, subtab, and section accessible in the chef portal.
> Updated: 2026-03-22
> Total pages: 347 routes

---

## SHORTCUTS (Top of Sidebar)

Customizable quick-access links. Defaults:
...
All available shortcut options (Settings > Navigation to customize):

- Activity, All Events, Briefing, Calendar, Charity Hub, Circles, Clients, Clover Parity (admin), Costing, Commerce, Contracts, Daily Ops, Dashboard, Documents, Goals, Inbox, Inquiries, Kitchen Mode, Menus, Messaging, Observability (admin), Portfolio, POS Register, Priorit Queue, Promotions, Prospecting (admin), Rate Card, Remy (admin), Staff, Stations, Table Service, Tasks, Travel, Virtual Terminal
...
- Spending History `/clients/history/spending-history`
...
- Create Event `/events/new`
  - From Text `/events/new/from-text`
  - Wizard `/events/new/wizard`
...
### Clover Parity `/commerce/parity` (admin only)

### Commerce Hub `/commerce`

### Observability `/commerce/observability` (admin only)
...
### Vendors (Culinary) `/culinary/vendors`
...
- Overview `/finance/overview`
  - Cash Flow `/finance/overview/cash-flow`
...
- Cash Flow Forecast `/finance/cash-flow`
- Break-Even `/finance/planning/break-even`
...
- Failed `/finance/payments/failed`
...
- Sales Tax `/finance/sales-tax`
  ...
  - Settings `/finance/sales-tax/settings`
...
### Social Hub `/social/hub-overview` (admin only)
...
- Business Health (alt) `/settings/protection/business-health`
...
### Beta Surveys `/admin/beta-surveys`

### Cannabis Tier `/admin/cannabis`
...
### Hub Groups `/admin/hub-groups`

### Live Presence `/admin/presence`
...
### Referral Partners `/admin/referral-partners`

### Social Feed `/admin/social`
...
- Network Profile `/settings/profile`
...
- My Services `/settings/my-services`
- Event Type Labels `/settings/event-types`
- Culinary Profile `/settings/culinary-profile`
- Professional Development `/settings/professional`
  - Momentum `/settings/professional/momentum`
  - Skills `/settings/professional/skills`
...
- Menu Engine `/settings/menu-engine`
- Seasonal Palettes `/settings/repertoire`
- Menu Templates `/settings/menu-templates`
- Print Settings `/settings/print`
- Taxonomy (Custom Lists) `/settings/taxonomy`
...
- Touchpoint Rules `/settings/touchpoints`
...
- GDPR & Data Privacy `/settings/compliance/gdpr`
- Food Safety & Certifications `/settings/compliance`
  - HACCP Plan `/settings/compliance/haccp`

### Finance

- Payment Methods (Digital Wallets) `/settings/payment-methods`
...
- Dashboard Widgets `/settings/dashboard`
...
- AI & Privacy Settings `/settings/ai-privacy`
- Remy Settings `/settings/remy`

### Protection

- Business Protection Hub `/settings/protection`
- Certifications `/settings/protection/certifications`
- Insurance Policies `/settings/protection/insurance`
- NDA & Photo Permissions `/settings/protection/nda`
- Business Continuity Plan `/settings/protection/continuity`
- Crisis Response `/settings/protection/crisis`
...
- Health Info `/settings/health`
- Incidents `/settings/incidents`

---

## STANDALONE PAGES (not in main nav)

- Activity Feed `/activity`
- Briefing `/briefing`
- Daily Ops `/daily`
- Dev Simulator `/dev/simulate`
- Documents `/documents`
- Network `/network`
  - Collabs `/network/collabs`
  - Notifications `/network/notifications`
  - Saved `/network/saved`
- Notifications `/notifications`
- Operations `/operations` (direct route, separate from Operations nav group)
...
- Commands `/commands`
- Conversation History `/remy`

---

## CANNABIS MODULE (special tier)

- About `/cannabis/about`
- Agreement `/cannabis/agreement`
- Compliance `/cannabis/compliance`
- Control Packet Template `/cannabis/control-packet/template`
- Events `/cannabis/events`
- Handbook `/cannabis/handbook`
- Hub `/cannabis/hub`
- Invite `/cannabis/invite`
- Ledger `/cannabis/ledger`
- RSVPs `/cannabis/rsvps`
- Unlock `/cannabis/unlock`

---

## MOBILE BOTTOM NAV (5 tabs, customizable)

Defaults: Home, Daily Ops, Inbox, Events, Clients

All options: Home, Daily Ops, Inbox, Events, Clients, Calendar, Inquiries, Menus, Recipes, Finance, Messaging, Documents, Costing, Queue, Settings
...
- Social Feed (admin) `/admin/social`
- Social Hub (admin) `/social/hub-overview`
- Network `/network`

---

_Total: 347 concrete routes across 13 nav groups + settings + standalone pages_
