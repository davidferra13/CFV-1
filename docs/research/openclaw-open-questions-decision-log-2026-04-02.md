...
| Q20 | What are the exact success metrics for 30, 90, and 180 days?                                        | Defines whether the build is working              | Handshake     | Open   |          |
...
| Q25 | What should the founder dashboard show every day to prove the system is progressing?                | Defines operational truth surface                 | Handshake     | Open   |          |
