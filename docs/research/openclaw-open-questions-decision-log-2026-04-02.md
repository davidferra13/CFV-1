...
| Q26 | What exact baseline window should we use before locking a KPI target?                               | Prevents fake certainty in early metrics          | Handshake     | Open    |                                                                                                                                                                                                                                              |
| Q27 | What minimum sample size is required before a KPI is trusted?                                       | Prevents tiny samples from driving the build      | Handshake     | Open    |                                                                                                                                                                                                                                              |
| Q28 | Which KPIs are primary outcome metrics, and which are only guardrails?                              | Prevents metric sprawl and wrong incentives       | Handshake     | Open    |                                                                                                                                                                                                                                              |
| Q29 | Which metrics are leading indicators, and which are lagging indicators?                             | Improves interpretation of movement over time     | Handshake     | Open    |                                                                                                                                                                                                                                              |
| Q30 | What exact denominator defines lookup success, recipe completion, and product usability?            | Prevents metric ambiguity                         | Handshake     | Open    |                                                                                                                                                                                                                                              |
