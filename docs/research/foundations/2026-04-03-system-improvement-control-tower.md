...
6. `docs/research/cross-system-continuity-audit.md`
7. `docs/research/route-discoverability-report.md`
8. `docs/research/production-reachability-report.md`
9. `docs/specs/platform-intelligence-hub.md`
10. `docs/research/competitive-intelligence-gap-closure-builder-handoff-2026-04-02.md`
...
3. open the narrower source doc for the assigned workstream
4. confirm whether the task is verification, consolidation, cleanup, spec-writing, or build execution
5. if the task spans ChefFlow website work, OpenClaw runtime work, or Raspberry Pi host work, classify it with `docs/research/builder-docket-runtime-ownership-map-2026-04-03.md` before choosing a spec or execution path
...
### Phase 3: Build the next ready safety and trust slice
...
### Phase 4: Build the ready continuity fixes before touching deeper system intelligence
...
### Phase 5: Build the ready dead-zone honesty pass and use existing consolidation slices first
...
### Phase 6: Use the existing reachability audit and decision register before deleting or recovering hidden surfaces
...
### Phase 7: Close assumption debt with real evidence
...
### Phase 8: Continue broader website and public-growth work through its own cross-reference
...
### Phase 9: Advance long-horizon platform intelligence and deeper competitor parity only when explicitly justified
