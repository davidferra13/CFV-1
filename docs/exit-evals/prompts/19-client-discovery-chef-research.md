...
> Wave 2 | 7 scenarios | Output: `docs/exit-evals/client/discovery-chef-research.md`
...
Category: **DISCOVERY & CHEF RESEARCH**
...
1. Write ALL output to: `docs/exit-evals/client/discovery-chef-research.md`
