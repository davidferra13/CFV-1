...
> Wave 3 | 8 scenarios | Output: `docs/exit-evals/admin/communication-support-user-relationships.md`
...
Category: **COMMUNICATION, SUPPORT & USER RELATIONSHIPS**
...
1. Write ALL output to: `docs/exit-evals/admin/communication-support-user-relationships.md`
