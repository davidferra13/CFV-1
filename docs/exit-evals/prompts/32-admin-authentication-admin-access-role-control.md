...
> Wave 3 | 8 scenarios | Output: `docs/exit-evals/admin/authentication-admin-access-role-control.md`
...
Category: **AUTHENTICATION, ADMIN ACCESS & ROLE CONTROL**
...
1. Write ALL output to: `docs/exit-evals/admin/authentication-admin-access-role-control.md`
