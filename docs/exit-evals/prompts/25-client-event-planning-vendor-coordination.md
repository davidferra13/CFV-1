...
> Wave 2 | 9 scenarios | Output: `docs/exit-evals/client/event-planning-vendor-coordination.md`
...
Category: **EVENT PLANNING & VENDOR COORDINATION**
...
Write this exact structure for each of the 9 scenarios:
...
1. Write ALL output to: `docs/exit-evals/client/event-planning-vendor-coordination.md`
...
4. Update `docs/exit-system-roadmap.md`: increment the evaluated count for client by 9
