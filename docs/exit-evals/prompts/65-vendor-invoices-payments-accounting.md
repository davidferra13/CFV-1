...
> Wave 6 | 8 scenarios | Output: `docs/exit-evals/vendor/invoices-payments-accounting.md`
...
Category: **INVOICES, PAYMENTS & ACCOUNTING**
...
1. Write ALL output to: `docs/exit-evals/vendor/invoices-payments-accounting.md`
