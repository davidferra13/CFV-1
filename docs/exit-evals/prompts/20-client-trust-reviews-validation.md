...
> Wave 2 | 6 scenarios | Output: `docs/exit-evals/client/trust-reviews-validation.md`
...
Category: **TRUST, REVIEWS & VALIDATION**
...
1. Write ALL output to: `docs/exit-evals/client/trust-reviews-validation.md`
...
4. Update `docs/exit-system-roadmap.md`: increment the evaluated count for client by 6
