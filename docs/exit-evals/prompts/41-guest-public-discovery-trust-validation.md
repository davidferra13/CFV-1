...
> Wave 4 | 7 scenarios | Output: `docs/exit-evals/guest/public-discovery-trust-validation.md`
...
Category: **PUBLIC DISCOVERY & TRUST VALIDATION**
...
1. Write ALL output to: `docs/exit-evals/guest/public-discovery-trust-validation.md`
