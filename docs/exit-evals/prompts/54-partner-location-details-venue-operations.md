...
> Wave 5 | 7 scenarios | Output: `docs/exit-evals/partner/location-details-venue-operations.md`
...
Category: **LOCATION DETAILS & VENUE OPERATIONS**
...
1. Write ALL output to: `docs/exit-evals/partner/location-details-venue-operations.md`
...
4. Update `docs/exit-system-roadmap.md`: increment the evaluated count for partner by 7
