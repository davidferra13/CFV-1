...
> Wave 2 | 4 scenarios | Output: `docs/exit-evals/client/legal-privacy-compliance.md`
...
1. Write ALL output to: `docs/exit-evals/client/legal-privacy-compliance.md`
...
4. Update `docs/exit-system-roadmap.md`: increment the evaluated count for client by 4
