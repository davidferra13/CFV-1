...
> Wave 2 | 5 scenarios | Output: `docs/exit-evals/client/travel-directions-day-of-movement.md`
...
Category: **TRAVEL, DIRECTIONS & DAY-OF MOVEMENT**
...
1. Write ALL output to: `docs/exit-evals/client/travel-directions-day-of-movement.md`
...
4. Update `docs/exit-system-roadmap.md`: increment the evaluated count for client by 5
