...
> Wave 3 | 8 scenarios | Output: `docs/exit-evals/admin/legal-policy-privacy-regulated-flows.md`
...
Category: **LEGAL, POLICY, PRIVACY & REGULATED FLOWS**
...
1. Write ALL output to: `docs/exit-evals/admin/legal-policy-privacy-regulated-flows.md`
