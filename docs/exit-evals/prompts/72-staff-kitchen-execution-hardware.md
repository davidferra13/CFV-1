...
> Wave 7 | 6 scenarios | Output: `docs/exit-evals/staff/kitchen-execution-hardware.md`
...
Category: **KITCHEN EXECUTION & HARDWARE**
...
1. Write ALL output to: `docs/exit-evals/staff/kitchen-execution-hardware.md`
