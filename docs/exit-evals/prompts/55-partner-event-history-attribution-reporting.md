...
> Wave 5 | 6 scenarios | Output: `docs/exit-evals/partner/event-history-attribution-reporting.md`
...
Category: **EVENT HISTORY, ATTRIBUTION & REPORTING**
...
1. Write ALL output to: `docs/exit-evals/partner/event-history-attribution-reporting.md`
...
4. Update `docs/exit-system-roadmap.md`: increment the evaluated count for partner by 6
