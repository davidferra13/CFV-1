...
> Wave 2 | 8 scenarios | Output: `docs/exit-evals/client/payments-money-receipts.md`
...
Category: **PAYMENTS, MONEY & RECEIPTS**
...
1. Write ALL output to: `docs/exit-evals/client/payments-money-receipts.md`
