...
> Wave 1 | 3 scenarios | Output: `docs/exit-evals/chef/during-service-the-kitchen-boundary.md`
...
Category: **DURING-SERVICE (The Kitchen Boundary)**
...
Write this exact structure for each of the 3 scenarios:
...
1. Write ALL output to: `docs/exit-evals/chef/during-service-the-kitchen-boundary.md`
...
4. Update `docs/exit-system-roadmap.md`: increment the evaluated count for chef by 3
