...
> Wave 3 | 8 scenarios | Output: `docs/exit-evals/admin/payments-finance-accounting.md`
...
Category: **PAYMENTS, FINANCE & ACCOUNTING**
...
1. Write ALL output to: `docs/exit-evals/admin/payments-finance-accounting.md`
