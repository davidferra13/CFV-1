...
> Wave 4 | 6 scenarios | Output: `docs/exit-evals/guest/photos-social-memory.md`
...
1. Write ALL output to: `docs/exit-evals/guest/photos-social-memory.md`
