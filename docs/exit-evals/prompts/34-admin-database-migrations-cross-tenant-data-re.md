...
> Wave 3 | 8 scenarios | Output: `docs/exit-evals/admin/database-migrations-cross-tenant-data-repair.md`
...
Category: **DATABASE, MIGRATIONS & CROSS-TENANT DATA REPAIR**
...
1. Write ALL output to: `docs/exit-evals/admin/database-migrations-cross-tenant-data-repair.md`
