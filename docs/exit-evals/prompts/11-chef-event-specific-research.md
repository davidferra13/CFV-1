...
> Wave 1 | 5 scenarios | Output: `docs/exit-evals/chef/event-specific-research.md`
...
Category: **EVENT-SPECIFIC RESEARCH**
...
1. Write ALL output to: `docs/exit-evals/chef/event-specific-research.md`
