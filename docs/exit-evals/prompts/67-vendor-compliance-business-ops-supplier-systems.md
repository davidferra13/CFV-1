...
> Wave 6 | 7 scenarios | Output: `docs/exit-evals/vendor/compliance-business-ops-supplier-systems.md`
...
Category: **COMPLIANCE, BUSINESS OPS & SUPPLIER SYSTEMS**
...
1. Write ALL output to: `docs/exit-evals/vendor/compliance-business-ops-supplier-systems.md`
