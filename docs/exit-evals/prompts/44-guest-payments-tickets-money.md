...
> Wave 4 | 7 scenarios | Output: `docs/exit-evals/guest/payments-tickets-money.md`
...
Category: **PAYMENTS, TICKETS & MONEY**
...
1. Write ALL output to: `docs/exit-evals/guest/payments-tickets-money.md`
