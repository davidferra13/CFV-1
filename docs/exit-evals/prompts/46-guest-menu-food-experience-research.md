...
> Wave 4 | 6 scenarios | Output: `docs/exit-evals/guest/menu-food-experience-research.md`
...
Category: **MENU, FOOD & EXPERIENCE RESEARCH**
...
1. Write ALL output to: `docs/exit-evals/guest/menu-food-experience-research.md`
