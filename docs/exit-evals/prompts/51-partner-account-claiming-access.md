...
> Wave 5 | 5 scenarios | Output: `docs/exit-evals/partner/account-claiming-access.md`
...
Category: **ACCOUNT CLAIMING & ACCESS**
...
1. Write ALL output to: `docs/exit-evals/partner/account-claiming-access.md`
