...
> Wave 4 | 7 scenarios | Output: `docs/exit-evals/guest/calendar-maps-arrival-logistics.md`
...
Category: **CALENDAR, MAPS & ARRIVAL LOGISTICS**
...
1. Write ALL output to: `docs/exit-evals/guest/calendar-maps-arrival-logistics.md`
