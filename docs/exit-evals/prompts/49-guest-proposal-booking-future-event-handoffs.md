...
> Wave 4 | 6 scenarios | Output: `docs/exit-evals/guest/proposal-booking-future-event-handoffs.md`
...
Category: **PROPOSAL, BOOKING & FUTURE EVENT HANDOFFS**
...
1. Write ALL output to: `docs/exit-evals/guest/proposal-booking-future-event-handoffs.md`
...
4. Update `docs/exit-system-roadmap.md`: increment the evaluated count for guest by 6
