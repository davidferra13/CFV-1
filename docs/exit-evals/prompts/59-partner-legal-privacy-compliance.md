...
> Wave 5 | 5 scenarios | Output: `docs/exit-evals/partner/legal-privacy-compliance.md`
...
1. Write ALL output to: `docs/exit-evals/partner/legal-privacy-compliance.md`
