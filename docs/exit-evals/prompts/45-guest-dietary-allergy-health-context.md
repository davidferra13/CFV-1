...
> Wave 4 | 6 scenarios | Output: `docs/exit-evals/guest/dietary-allergy-health-context.md`
...
Category: **DIETARY, ALLERGY & HEALTH CONTEXT**
...
1. Write ALL output to: `docs/exit-evals/guest/dietary-allergy-health-context.md`
