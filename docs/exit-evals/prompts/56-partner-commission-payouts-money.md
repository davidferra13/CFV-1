...
> Wave 5 | 6 scenarios | Output: `docs/exit-evals/partner/commission-payouts-money.md`
...
Category: **COMMISSION, PAYOUTS & MONEY**
...
1. Write ALL output to: `docs/exit-evals/partner/commission-payouts-money.md`
