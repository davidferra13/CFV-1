...
> Wave 7 | 7 scenarios | Output: `docs/exit-evals/staff/clock-pay-banking-tax.md`
...
Category: **CLOCK, PAY, BANKING & TAX**
...
1. Write ALL output to: `docs/exit-evals/staff/clock-pay-banking-tax.md`
...
4. Update `docs/exit-system-roadmap.md`: increment the evaluated count for staff by 7
