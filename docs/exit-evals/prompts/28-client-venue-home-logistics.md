...
> Wave 2 | 8 scenarios | Output: `docs/exit-evals/client/venue-home-logistics.md`
...
1. Write ALL output to: `docs/exit-evals/client/venue-home-logistics.md`
