...
> Wave 5 | 5 scenarios | Output: `docs/exit-evals/partner/day-of-operations.md`
...
1. Write ALL output to: `docs/exit-evals/partner/day-of-operations.md`
