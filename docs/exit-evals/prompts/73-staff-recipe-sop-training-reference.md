...
> Wave 7 | 6 scenarios | Output: `docs/exit-evals/staff/recipe-sop-training-reference.md`
...
Category: **RECIPE, SOP & TRAINING REFERENCE**
...
1. Write ALL output to: `docs/exit-evals/staff/recipe-sop-training-reference.md`
