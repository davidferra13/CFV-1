...
> Wave 7 | 5 scenarios | Output: `docs/exit-evals/staff/supplies-inventory-emergency-purchasing.md`
...
Category: **SUPPLIES, INVENTORY & EMERGENCY PURCHASING**
...
1. Write ALL output to: `docs/exit-evals/staff/supplies-inventory-emergency-purchasing.md`
