...
> Wave 4 | 7 scenarios | Output: `docs/exit-evals/guest/dinner-circle-no-login-profile-access.md`
...
Category: **DINNER CIRCLE & NO-LOGIN PROFILE ACCESS**
...
1. Write ALL output to: `docs/exit-evals/guest/dinner-circle-no-login-profile-access.md`
