...
> Wave 1 | 5 scenarios | Output: `docs/exit-evals/chef/client-research-relationship.md`
...
Category: **CLIENT RESEARCH & RELATIONSHIP**
...
1. Write ALL output to: `docs/exit-evals/chef/client-research-relationship.md`
