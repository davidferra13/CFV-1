...
> Wave 3 | 8 scenarios | Output: `docs/exit-evals/admin/web-research-directory-outreach.md`
...
Category: **WEB RESEARCH, DIRECTORY & OUTREACH**
...
1. Write ALL output to: `docs/exit-evals/admin/web-research-directory-outreach.md`
