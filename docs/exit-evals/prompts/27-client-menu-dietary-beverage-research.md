...
> Wave 2 | 8 scenarios | Output: `docs/exit-evals/client/menu-dietary-beverage-research.md`
...
Category: **MENU, DIETARY & BEVERAGE RESEARCH**
...
1. Write ALL output to: `docs/exit-evals/client/menu-dietary-beverage-research.md`
...
4. Update `docs/exit-system-roadmap.md`: increment the evaluated count for client by 8
