...
> Wave 5 | 5 scenarios | Output: `docs/exit-evals/partner/communication-relationship-management.md`
...
Category: **COMMUNICATION & RELATIONSHIP MANAGEMENT**
...
1. Write ALL output to: `docs/exit-evals/partner/communication-relationship-management.md`
