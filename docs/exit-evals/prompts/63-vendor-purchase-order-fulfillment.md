...
> Wave 6 | 9 scenarios | Output: `docs/exit-evals/vendor/purchase-order-fulfillment.md`
...
Category: **PURCHASE ORDER FULFILLMENT**
...
1. Write ALL output to: `docs/exit-evals/vendor/purchase-order-fulfillment.md`
