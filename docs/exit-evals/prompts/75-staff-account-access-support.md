...
> Wave 7 | 5 scenarios | Output: `docs/exit-evals/staff/account-access-support.md`
...
Category: **ACCOUNT, ACCESS & SUPPORT**
...
1. Write ALL output to: `docs/exit-evals/staff/account-access-support.md`
