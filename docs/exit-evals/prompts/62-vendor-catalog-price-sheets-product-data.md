...
> Wave 6 | 9 scenarios | Output: `docs/exit-evals/vendor/catalog-price-sheets-product-data.md`
...
Category: **CATALOG, PRICE SHEETS & PRODUCT DATA**
...
1. Write ALL output to: `docs/exit-evals/vendor/catalog-price-sheets-product-data.md`
...
4. Update `docs/exit-system-roadmap.md`: increment the evaluated count for vendor by 9
