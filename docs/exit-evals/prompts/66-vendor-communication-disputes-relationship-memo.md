...
> Wave 6 | 8 scenarios | Output: `docs/exit-evals/vendor/communication-disputes-relationship-memory.md`
...
Category: **COMMUNICATION, DISPUTES & RELATIONSHIP MEMORY**
...
1. Write ALL output to: `docs/exit-evals/vendor/communication-disputes-relationship-memory.md`
