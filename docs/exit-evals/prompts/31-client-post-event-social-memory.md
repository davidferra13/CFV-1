...
> Wave 2 | 7 scenarios | Output: `docs/exit-evals/client/post-event-social-memory.md`
...
Category: **POST-EVENT, SOCIAL & MEMORY**
...
1. Write ALL output to: `docs/exit-evals/client/post-event-social-memory.md`
