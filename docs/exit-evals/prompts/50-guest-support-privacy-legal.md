...
> Wave 4 | 6 scenarios | Output: `docs/exit-evals/guest/support-privacy-legal.md`
...
Category: **SUPPORT, PRIVACY & LEGAL**
...
1. Write ALL output to: `docs/exit-evals/guest/support-privacy-legal.md`
