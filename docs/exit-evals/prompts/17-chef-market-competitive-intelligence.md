...
> Wave 1 | 2 scenarios | Output: `docs/exit-evals/chef/market-competitive-intelligence.md`
...
Write this exact structure for each of the 2 scenarios:
...
1. Write ALL output to: `docs/exit-evals/chef/market-competitive-intelligence.md`
...
4. Update `docs/exit-system-roadmap.md`: increment the evaluated count for chef by 2
