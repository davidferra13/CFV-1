...
> Wave 1 | 7 scenarios | Output: `docs/exit-evals/chef/operational-tools-calculations-part2.md`
...
1. Write ALL output to: `docs/exit-evals/chef/operational-tools-calculations-part2.md`
