...
description: Use when building ChefFlow code, implementing features, refactoring, reviewing module organization, or checking that changes keep interfaces, seams, locality, and test surfaces organized.
---
