...
- **Modular refinement always.** As builds expand, continuously refine repeated logic, tangled UI, and fuzzy domain behavior into deep TypeScript modules with small public interfaces. Use the `software-fundamentals` skill as the Matt Pocock-style lens: shared language, clear boundaries, tested contracts, hidden complexity, and humans owning architecture.
