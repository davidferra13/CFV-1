...
| Pricing, menu costing, ingredient coverage, OpenClaw price data, local grocery coverage, quote safety, or release-readiness blocker questions                                             | `pricing-reliability` with `pipeline` and `evidence-integrity` as needed |
