...
import { resolveObsidianVault, writeMemoryPacket } from './context-continuity-lib.mjs'

const args = parseArgs()
const title = args.title || args._.join(' ') || 'Context Continuity Packet'
const vault =
  args['no-vault'] || args['repo-only']
    ? null
    : resolveObsidianVault(args.vault && args.vault !== true ? String(args.vault) : null)
