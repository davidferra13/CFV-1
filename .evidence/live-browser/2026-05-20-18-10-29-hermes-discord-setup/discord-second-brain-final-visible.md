              ...
              - listitem [ref=e1844]:
                - link "daily-brief (text channel)" [ref=e9687] [cursor=pointer]:
                  ...
                  - generic [ref=e1848]:
                    ...
                    - generic [ref=e11952]:
                      - button "Invite to Channel" [ref=e11954]:
                        - img [ref=e11955]
                      - generic [ref=e1854]: Invite to Channel
                      - button "Edit Channel" [ref=e11959]:
                        - img [ref=e11960]
            ...
            - generic [ref=e377]:
              ...
              - generic [ref=e387]:
                ...
                - button "User Settings" [ref=e9768] [cursor=pointer]:
                  - img [ref=e435]
        - generic [ref=e10874]:
          - region "Channel header" [ref=e11962]:
            - generic [ref=e11963]:
              - generic [ref=e11964]:
                - img [ref=e11966]
                - generic [ref=e11968]: Text Channel
                - 'heading "Hermes : Chef Flow: daily-brief" [level=1] [ref=e11970]':
                  - generic [ref=e11971]: "Hermes : Chef Flow:"
                  - text: daily-brief
              - generic [ref=e11972]:
                - button "Threads" [ref=e11973] [cursor=pointer]:
                  - img [ref=e11974]
                - button "Notification Settings" [ref=e11976] [cursor=pointer]:
                  - img [ref=e11977]
                - button "Pinned Messages" [ref=e11979] [cursor=pointer]:
                  - img [ref=e11980]
                - button "Show Member List" [ref=e11982] [cursor=pointer]:
                  - img [ref=e11983]
                - generic [ref=e11987]:
                  - generic [ref=e11988]:
                    - generic [ref=e11990]: "Search Hermes : Chef Flow"
                    - combobox "Search" [ref=e11992]
                  - button [ref=e11996]:
                    - generic [ref=e11997]:
                      - img [ref=e11998]
                      - img [ref=e12000]
          - main "daily-brief (channel)" [ref=e12002]:
            - heading "daily-brief chat" [level=2] [ref=e12004]
            - group [ref=e12006]:
              - list "Messages in daily-brief" [ref=e12008]:
                - generic [ref=e12009]:
                  - img [ref=e12011]
                  - heading [level=3] [ref=e12013]: "Welcome to #daily-brief!"
                  - generic [ref=e12014]: "This is the start of the #daily-brief channel."
                  - button "Edit Channel" [ref=e12016] [cursor=pointer]:
                    - generic [ref=e12018]:
                      - img [ref=e12019]
                      - generic [ref=e12021]: Edit Channel
                - separator "May 20, 2026":
                  - generic: May 20, 2026
                - listitem [ref=e12100]:
                  - 'article "Kabutops , Daily brief contract Hermes should use this channel for one compact operating brief, not a dump. Daily brief shape: Current queue counts: active / in-flight / blocked / done , New blockers or risks , Most important proof gaps , Today’s best next action , Any overnight Hermes/Sentinel changes , Links to source docs or proof, not pasted long reports , Primary source docs: docs/hermes/morning-report.md , docs/hermes/git-changelog.md , .agents/build-queue/events.jsonl , .agents/proof/ , , 3:02 PM" [ref=e12101]':
                    - generic [ref=e12102]:
                      - img [ref=e12103] [cursor=pointer]
                      - heading "Kabutops 3:02 PM" [level=3] [ref=e12104]:
                        - button "Kabutops" [ref=e12106]
                        - generic:
                          - generic:
                            - time:
                              - generic: —
                              - text: 3:02 PM
                          - generic: Wednesday, May 20, 2026 at 3:02 PM
                      - generic [ref=e12107]:
                        - text: "Daily brief contract Hermes should use this channel for one compact operating brief, not a dump. Daily brief shape:"
                        - list [ref=e12108]:
                          - listitem [ref=e12109]:
                            - generic [ref=e12110]: "Current queue counts: active / in-flight / blocked / done"
                            - generic [ref=e12111]: ","
                          - listitem [ref=e12112]:
                            - generic [ref=e12113]: New blockers or risks
                            - generic [ref=e12114]: ","
                          - listitem [ref=e12115]:
                            - generic [ref=e12116]: Most important proof gaps
                            - generic [ref=e12117]: ","
                          - listitem [ref=e12118]:
                            - generic [ref=e12119]: Today’s best next action
                            - generic [ref=e12120]: ","
                          - listitem [ref=e12121]:
                            - generic [ref=e12122]: Any overnight Hermes/Sentinel changes
                            - generic [ref=e12123]: ","
                          - listitem [ref=e12124]:
                            - generic [ref=e12125]: Links to source docs or proof, not pasted long reports
                            - generic [ref=e12126]: ","
                        - text: "Primary source docs:"
                        - list [ref=e12127]:
                          - listitem [ref=e12128]:
                            - generic [ref=e12129]: docs/hermes/morning-report.md
                            - generic [ref=e12130]: ","
                          - listitem [ref=e12131]:
                            - generic [ref=e12132]: docs/hermes/git-changelog.md
                            - generic [ref=e12133]: ","
                          - listitem [ref=e12134]:
                            - generic [ref=e12135]: .agents/build-queue/events.jsonl
                            - generic [ref=e12136]: ","
                          - listitem [ref=e12137]:
                            - generic [ref=e12138]: .agents/proof/
                            - generic [ref=e12139]: ","
            - generic [ref=e12027]:
              - button "More message options" [ref=e12029] [cursor=pointer]:
                - img [ref=e12031]
              - generic [ref=e12034]:
                - generic: "Message #daily-brief"
                - 'textbox "Message #daily-brief" [active] [ref=e12035]'
              - generic [ref=e12037]:
                - button "Send a gift" [ref=e12038] [cursor=pointer]:
                  - img [ref=e12041]
                - generic [ref=e12054]: Upgrade your friends! Gift them awesome chat perks with Nitro.
                - button "Open GIF picker" [ref=e12056] [cursor=pointer]:
                  - img [ref=e12059]
                - generic [ref=e12066]: Send GIF
                - button "Open sticker picker" [ref=e12068] [cursor=pointer]:
                  - img [ref=e12071]
                - button "Add Emoji" [ref=e12078] [cursor=pointer]
                - button "Apps" [ref=e12083] [cursor=pointer]:
                  - img [ref=e12085]
  - generic:
    - img
