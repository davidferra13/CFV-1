...
export function OfflineNavIndicator() {
  ...
  if (syncProgress?.isSyncing) {
    return (
      <div
        className="flex items-center gap-1.5 px-2 py-1 rounded-md bg-blue-50 border border-blue-200 flex-shrink-0"
  ...
  if (isOffline && pendingCount > 0) {
    return (
      <div
        className="flex items-center gap-1.5 px-2 py-1 rounded-md bg-stone-100 border border-stone-300 flex-shrink-0"
      ...
      >
        ...
        <span className="text-xs font-medium text-stone-700">Offline</span>
        <span className="inline-flex items-center gap-0.5 bg-stone-200 rounded-full px-1.5 py-0.5 text-[10px] font-medium text-stone-600">
  ...
  if (isOffline) {
    return (
      <div
        className="flex items-center gap-1.5 px-2 py-1 rounded-md bg-red-50 border border-red-200 flex-shrink-0"
  ...
  if (isOnline && pendingCount > 0) {
    return (
      <div
        className="flex items-center gap-1.5 px-2 py-1 rounded-md bg-amber-50 border border-amber-200 flex-shrink-0"
