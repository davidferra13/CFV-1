...
export function PrintableDocument({
  ...
  const defaultFooter = printedAt ? `ChefFlow - Printed ${printedAt}` : 'ChefFlow'
    ...
    <div className={`${classes.preview} ${classes.print} p-4`}>
      ...
      {generatedBy && (
        <div
          ...
          style={{
            marginTop: '12px',
            fontSize: mode === 'standard' ? '9px' : '7px',
            color: '#aaa',
          }}
        >
      ...
      <div
        className="print-meta"
        style={{
          marginTop: generatedBy ? '2px' : '12px',
          fontSize: mode === 'standard' ? '10px' : '8px',
        }}
      >
