  ...
  if (submitted) {
    return (
      <div className="mx-auto max-w-lg rounded-lg bg-white p-8 text-center shadow-md">
        ...
        <p className="mt-2 text-gray-600">Your feedback has been submitted. We appreciate you taking the time to share your experience.</p>
      </div>
    )
  }

  return (
    <form onSubmit={handleSubmit} className="mx-auto max-w-lg space-y-6 rounded-lg bg-white p-8 shadow-md">
      {eventTitle && (
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700">Would you recommend us to others?</label>
