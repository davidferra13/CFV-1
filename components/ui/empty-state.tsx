...
export function EmptyState({
  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 px-6 text-center animate-fade-slide-up select-none">
      {illustration ? (
      ...
      <h3 className="text-lg font-semibold text-stone-100 mb-2 tracking-tight">{title}</h3>
