                ...
                return (
                  <Card key={journey.id} className="border-stone-700">
                    <CardContent className="pt-5 space-y-4">
                      ...
                      <div className="rounded-md border border-brand-200 bg-brand-950 px-3 py-2 text-xs text-brand-900 flex items-start gap-2">
                        <Camera className="w-3.5 h-3.5 mt-0.5 text-brand-700" />
