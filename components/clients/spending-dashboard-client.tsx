  ...
  if (events.length === 0) {
    return (
      <div className="max-w-3xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-stone-900">My Spending</h1>
          <p className="text-stone-600 mt-1">Your financial history with your chef</p>
        </div>
        <Card>
    ...
    <div className="max-w-3xl mx-auto">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
        ...
        <Card>
          <CardContent className="p-4 text-center">
            ...
            <div className="text-xl font-bold text-stone-900">{eventsAttended}</div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-4 text-center">
        ...
        <Card className="mb-6 border-brand-200 bg-brand-50">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-brand-900">Upcoming Committed Spend</p>
                <p className="text-xs text-brand-700 mt-0.5">Already paid toward future events</p>
              </div>
      ...
      {upcomingEvents.length > 0 && (
        <section className="mb-8">
          <h2 className="text-lg font-semibold text-stone-900 mb-3">Upcoming</h2>
          <Card>
      ...
      {pastEvents.length > 0 && (
        <section className="mb-8">
          <h2 className="text-lg font-semibold text-stone-900 mb-3">Past Events</h2>
          <Card>
            <CardContent className="p-0">
              <div className="divide-y divide-stone-100">
          ...
          {/* Total row */}
          <div className="mt-2 flex justify-between items-center px-4 text-sm text-stone-600">
      ...
      {cancelledEvents.length > 0 && (
        <section>
          <h2 className="text-lg font-semibold text-stone-900 mb-3 text-stone-400">Cancelled</h2>
