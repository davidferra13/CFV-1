...
export function FunQAForm({ initialAnswers }: FunQAFormProps) {
  ...
  const filledCount = FUN_QA_QUESTIONS.filter(
        ...
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-stone-500 mt-1">
              No pressure at all — answer as many or as few as you like.
              Your chef uses these to make every experience feel a little
              more you.
            </p>
          </div>
          {filledCount > 0 && (
            <span className="shrink-0 text-xs font-medium bg-brand-50 text-brand-700 border border-brand-200 rounded-full px-2.5 py-1">
