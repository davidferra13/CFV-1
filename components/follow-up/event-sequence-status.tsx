...
const STATUS_STYLES: Record<string, { bg: string; text: string; label: string }> = {
  pending: { bg: 'bg-amber-50', text: 'text-amber-200', label: 'Scheduled' },
  sent: { bg: 'bg-green-50', text: 'text-green-200', label: 'Sent' },
  opened: { bg: 'bg-blue-50', text: 'text-blue-200', label: 'Opened' },
  clicked: { bg: 'bg-indigo-50', text: 'text-indigo-200', label: 'Clicked' },
  bounced: { bg: 'bg-red-50', text: 'text-red-200', label: 'Bounced' },
