...
const LABEL_CONFIG = {
  hot: { className: 'bg-red-900 text-red-200', emoji: '🔥', label: 'Hot' },
  warm: { className: 'bg-amber-900 text-amber-200', emoji: '☀️', label: 'Warm' },
  cold: { className: 'bg-sky-900 text-sky-200', emoji: '❄️', label: 'Cold' },
}
