...
const TAGS: {
...
}[] = [
  {
    ...
    activeColor: 'bg-red-9500 text-white border-red-500',
  },
  {
    value: 'warm',
    label: 'Warm',
    ...
    activeColor: 'bg-amber-9500 text-white border-amber-500',
  },
  {
    value: 'cold',
    label: 'Cold',
    ...
    activeColor: 'bg-blue-9500 text-white border-blue-500',
  },
]
