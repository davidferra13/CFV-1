      ...
      <div className="rounded-lg border border-stone-200 p-4 bg-white">
        <div className="flex items-start justify-between gap-4">
          <div className="flex-1">
            <p className="font-medium text-stone-900">Business Mode</p>
        ...
        {localEnabled && (
          <div className="mt-4 pt-4 border-t border-stone-100 space-y-2">
            <p className="text-xs font-semibold text-stone-500 uppercase tracking-wide">Business Tools</p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              <Link
                href="/finance/tax"
                className="block rounded-md border border-stone-200 px-3 py-2 text-sm hover:bg-stone-50 transition-colors"
              >
                <p className="font-medium text-stone-900">Tax Workflow</p>
              ...
              <Link
                ...
                className="block rounded-md border border-stone-200 px-3 py-2 text-sm hover:bg-stone-50 transition-colors"
              >
                <p className="font-medium text-stone-900">Compliance</p>
              ...
              <Link
                ...
                className="block rounded-md border border-stone-200 px-3 py-2 text-sm hover:bg-stone-50 transition-colors"
              >
                <p className="font-medium text-stone-900">Contract Templates</p>
                <p className="text-xs text-stone-500">Service agreements and client contracts</p>
              </Link>
            </div>
            {(businessLegalName || businessAddress) && (
              <div className="mt-2 rounded-md bg-stone-50 px-3 py-2 text-sm text-stone-600">
                {businessLegalName && <p><span className="font-medium">Legal name:</span> {businessLegalName}</p>}
                {businessAddress && <p><span className="font-medium">Address:</span> {businessAddress}</p>}
              </div>
            )}
          </div>
        )}
