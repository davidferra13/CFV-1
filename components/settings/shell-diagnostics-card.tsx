        ...
        <div className="rounded-lg border border-stone-800 bg-stone-950/40 px-4 py-4">
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div className="space-y-2">
              ...
              <p className="text-sm text-stone-400">
                Clears client-only shell presentation keys and restores default shell chrome.
                Mobile tab preferences, Focus Mode, permissions, and route access stay unchanged.
              </p>
