  ...
  return (
    <div className="bg-surface rounded-lg border border-stone-700 p-3 flex flex-col gap-2 hover:border-stone-600 hover:shadow-sm transition-all min-h-[120px]">
      ...
      <div className="flex-1">
        <p className="text-sm font-medium text-stone-200 line-clamp-2 leading-snug">
...
export function SocialEmptySlotCard() {
  return (
    <div className="bg-stone-800 rounded-lg border border-dashed border-stone-700 p-3 flex items-center justify-center min-h-[120px] text-stone-400 text-sm">
