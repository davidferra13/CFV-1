...
const TONE_STYLES = {
  ...
  emerald: {
    panel: 'border-emerald-800/60 bg-gradient-to-br from-emerald-950/55 via-stone-950 to-stone-950',
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            {task.remainingCount > 0 ? (
              <span className="text-xs font-medium text-stone-400">
                {task.remainingCount} {task.remainingLabel ?? 'more waiting after this'}
              </span>
            ) : null}
          </div>
