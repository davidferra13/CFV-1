...
export function TaskCreateFields({ staff, stations, draft }: Props) {
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <select name="assigned_to" defaultValue={draft.assigned_to} className={FIELD_CLASSNAME}>
            {hasInvalidAssignee ? (
        ...
        <div>
          ...
          <select name="station_id" defaultValue={draft.station_id} className={FIELD_CLASSNAME}>
            {hasInvalidStation ? (
