...
export function BookingScoreBadge({ score }: BookingScoreBadgeProps) {
  ...
  return (
    ...
    >
      ...
      {showBreakdown && (
        <div className="absolute bottom-full mb-2 left-1/2 -translate-x-1/2 z-float w-56 bg-stone-900 border border-stone-700 rounded-lg shadow-lg p-3 text-xs text-stone-300">
