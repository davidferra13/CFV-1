...
const COMMON_DIETARY_SUGGESTIONS = [
  ...
  'Kosher', 'Halal', 'Keto', 'Paleo', 'Pescatarian',
]
...
export function EventCreationWizard({ clients }: EventCreationWizardProps) {
  ...
  const handleCreate = () => {
    ...
    const quotedPriceCents = budgetMax
      ? parseCurrencyToCents(budgetMax)
      : undefined
          ...
          return (
            <div key={label} className="flex items-center gap-2 flex-1">
              ...
              {i < STEP_LABELS.length - 1 && (
                <div className="flex-1 h-px bg-stone-200 min-w-4" />
              )}
            </div>
          )
        })}
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm text-stone-500 mt-1">
                Choose the client for this event
              </p>
            </div>
            ...
            {filteredClients.length === 0 ? (
              <div className="text-center py-8 text-stone-500">
                ...
                <p className="text-xs mt-1">
                  Add a client from the Clients page first.
                </p>
              </div>
            ) : (
        ...
        {step === 2 && (
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm text-stone-500 mt-1">
                Enter the core details for this event
              </p>
            </div>
        ...
        {step === 4 && (
          <div className="space-y-5">
            ...
            <div className="rounded-lg border border-stone-200 p-4">
              ...
              <dl className="grid grid-cols-2 gap-x-4 gap-y-2 text-sm">
                ...
                <dd className="text-stone-900">
                  {SERVICE_STYLE_OPTIONS.find((o) => o.value === serviceStyle)?.label || 'Not specified'}
                </dd>
            ...
            <Alert variant="info" title="Status">
              This event will be created in <strong>draft</strong> status. You can
              propose it to the client after adding pricing and a menu.
            </Alert>
