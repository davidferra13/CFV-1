  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="p-5">
        ...
        <div className="mt-5 space-y-4">
          {dishes.map((dish) => {
            ...
            return (
              <div key={dish.key} className="rounded-xl border border-stone-700 bg-stone-950/60 p-4">
                ...
                {isExtra && (
                  <div className="mt-3 grid gap-3 md:grid-cols-2">
                    <input
                      ...
                      onChange={(event) => updateDish(dish.key, { plannedName: event.target.value })}
                ...
                <div className="mt-4 grid gap-3 md:grid-cols-[1fr_auto]">
                  ...
                  <div className="rounded-lg border border-stone-700 bg-stone-900 px-3 py-2 text-xs text-stone-400">
                    ...
                    <p>
                      Avg rating:{' '}
                      {dish.averageRating !== null ? `${dish.averageRating.toFixed(1)}/5` : 'Pending'}
                    </p>
                  </div>
                </div>
              </div>
      ...
      <div className="flex items-center justify-end gap-3">
        <Button type="button" variant="ghost" onClick={() => router.push(`/events/${capture.event.id}`)}>
          Back to Event
        </Button>
