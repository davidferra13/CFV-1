...
export function CancellationPolicyDisplay({ variant, policy = DEFAULT_POLICY }: Props) {
  if (variant === 'compact') {
    return (
      <div className="flex items-start gap-2 text-sm text-stone-500 bg-stone-800 border border-stone-700 rounded-lg px-4 py-3">
        <svg
          className="w-4 h-4 mt-0.5 flex-shrink-0 text-stone-400"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
        ...
        <span>
          <strong className="text-stone-300">Cancellation policy:</strong>{' '}
  ...
  return (
    <div className="border border-stone-700 rounded-lg overflow-hidden">
      <div className="px-4 py-3 bg-stone-800 border-b border-stone-700">
        <h3 className="text-sm font-semibold text-stone-300">Cancellation Policy</h3>
      </div>
      ...
      <div className="px-4 py-3 bg-stone-800 border-t border-stone-700">
