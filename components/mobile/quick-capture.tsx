  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-4 z-fab w-14 h-14 bg-stone-900 text-white rounded-full shadow-lg flex items-center justify-center hover:bg-stone-700 transition-all active:scale-95 sm:hidden"
      ...
      {open && (
        <>
          {/* Backdrop */}
          <div
            className="fixed inset-0 z-page-bar sm:hidden"
            onClick={() => setOpen(false)}
            aria-hidden
          />
          <div className="fixed bottom-24 right-4 z-fab flex flex-col gap-3 sm:hidden">
      ...
      {showExpenseForm && (
        <div
          className="fixed inset-0 z-dialog flex items-end sm:items-center justify-center bg-black/40"
          onClick={(e) => {
