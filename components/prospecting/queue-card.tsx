        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2">
            ...
            <Link
              ...
              className="font-medium text-stone-900 hover:underline truncate"
        ...
        <div className="border-t border-stone-100 p-4 space-y-4">
          ...
          {prospect.talking_points && (
            <div className="bg-stone-50 border border-stone-200 rounded-lg p-3">
              <p className="text-xs font-medium text-stone-700 mb-1">Talking Points</p>
              <p className="text-sm text-stone-800">{prospect.talking_points}</p>
            </div>
          )}
          ...
          {script && (
            <div className="bg-stone-50 border border-stone-200 rounded-lg p-3">
              <p className="text-xs font-medium text-stone-700 mb-1">Call Script: {script.name}</p>
              <p className="text-sm text-stone-800 whitespace-pre-wrap">{script.script_body}</p>
            </div>
          )}
          ...
          <textarea
            ...
            className="w-full h-16 rounded-lg border border-stone-200 px-3 py-2 text-sm resize-none focus:outline-none focus:ring-2 focus:ring-brand-500"
            disabled={isPending}
          />

          {/* Follow-up days selector (shows when relevant) */}
          <div className="flex items-center gap-2 text-sm">
            <span className="text-stone-600">Follow up in</span>
            <select
              value={followUpDays}
