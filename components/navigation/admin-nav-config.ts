...
export const adminNavGroups: AdminNavGroup[] = [
  {
    ...
    items: [
      ...
      { href: '/admin/flags', label: 'Feature Switches', icon: FlagBanner },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/admin/openclaw/health', label: 'Data Status', icon: Activity },
      { href: '/admin/pie-compliance', label: 'Pricing Status', icon: ShieldCheck },
      { href: '/admin/web-research', label: 'Web Research', icon: Search },
      { href: '/admin/feedback', label: 'Feedback', icon: Star },
      { href: '/admin/presence', label: 'Live Presence', icon: WifiHigh },
      { href: '/admin/silent-failures', label: 'Hidden Issues', icon: AlertTriangle },
      { href: '/admin/beta-surveys', label: 'Surveys', icon: ClipboardCheck },
      { href: '/admin/system', label: 'Connection Status', icon: ShieldCheck },
      { href: '/dev/diagnosis', label: 'Troubleshooting', icon: Activity },
      { href: '/dev/integrity', label: 'System Check', icon: ClipboardCheck },
    ],
  },
]
