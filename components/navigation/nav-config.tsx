    ...
    items: [
      ...
      },
      {
        ...
        children: [
          ...
          { href: '/staff/schedule', label: 'Staff Schedule', icon: CalendarDays, visibility: 'advanced' },
          { href: '/staff/availability', label: 'Staff Availability', icon: Users, visibility: 'advanced' },
          { href: '/staff/clock', label: 'Clock In/Out', icon: Clock, visibility: 'advanced' },
          { href: '/staff/performance', label: 'Staff Performance', icon: BarChart3, visibility: 'advanced' },
          { href: '/staff/labor', label: 'Labor Dashboard', icon: DollarSign, visibility: 'advanced' },
          { href: '/inventory', label: 'Inventory', icon: Warehouse, visibility: 'advanced' },
          { href: '/inventory/waste', label: 'Waste Tracking', icon: Package, visibility: 'advanced' },
          { href: '/inventory/vendor-invoices', label: 'Vendor Invoices', icon: FileText, visibility: 'advanced' },
          { href: '/inventory/food-cost', label: 'Food Cost Analysis', icon: PieChart, visibility: 'advanced' },
    ...
    items: [
      {
        ...
        children: [
          ...
          { href: '/finance/bank-feed', label: 'Bank Feed', icon: Landmark, visibility: 'advanced' },
          { href: '/finance/cash-flow', label: 'Cash Flow Forecast', icon: TrendingUp, visibility: 'advanced' },
          { href: '/finance/recurring', label: 'Recurring Invoices', icon: RefreshCw, visibility: 'advanced' },
          { href: '/finance/disputes', label: 'Payment Disputes', icon: ShieldAlert, visibility: 'advanced' },
          { href: '/finance/contractors', label: '1099 Contractors', icon: Users, visibility: 'advanced' },
          { href: '/finance/tax/quarterly', label: 'Quarterly Estimates', icon: PieChart, visibility: 'advanced' },
        ],
      },
    ],
  },
...
const settingsShortcutOptions: PrimaryShortcutOption[] = [
  ...
  { href: '/settings/appearance', label: 'Appearance & Dark Mode', icon: Settings, context: 'Settings' },
  ...
  { href: '/settings/compliance/gdpr', label: 'GDPR & Data Privacy', icon: Settings, context: 'Settings' },
  { href: '/settings/custom-fields', label: 'Custom Fields', icon: Settings, context: 'Settings' },
  { href: '/settings/event-types', label: 'Event Type Labels', icon: Settings, context: 'Settings' },
