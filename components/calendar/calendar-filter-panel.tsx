...
const FILTER_DEFS: FilterDef[] = [
  {
    key: 'showEvents',
    label: 'Events',
    activeColor: 'bg-amber-900 text-amber-200 border-amber-300',
    dotColor: '#F59E0B',
  },
  {
    key: 'showDraftEvents',
    label: 'Drafts',
    activeColor: 'bg-yellow-900 text-yellow-200 border-yellow-300',
    dotColor: '#FDE68A',
  },
  {
    key: 'showPrepBlocks',
    label: 'Prep',
    activeColor: 'bg-green-900 text-green-200 border-green-300',
    dotColor: '#16A34A',
  },
  {
    key: 'showCalls',
    label: 'Calls',
    activeColor: 'bg-blue-900 text-blue-200 border-blue-300',
    dotColor: '#3B82F6',
  },
  {
    key: 'showPersonal',
    label: 'Personal',
    activeColor: 'bg-purple-900 text-purple-200 border-purple-300',
    dotColor: '#7C3AED',
  },
  {
    key: 'showBusiness',
    label: 'Business',
    activeColor: 'bg-teal-900 text-teal-200 border-teal-300',
    dotColor: '#0D9488',
  },
  {
    key: 'showIntentions',
    label: 'Goals',
    activeColor: 'bg-green-950 text-green-200 border-green-200',
    dotColor: '#4ADE80',
  },
  {
    key: 'showLeads',
    label: 'Leads',
    activeColor: 'bg-orange-900 text-orange-200 border-orange-300',
    dotColor: '#EA580C',
  },
]
