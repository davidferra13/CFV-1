        ...
        <CardContent className="pt-6">
          <div className="text-center space-y-4">
            ...
            <div>
              ...
              <p className="text-sm text-stone-600 mt-1">Your review helps us improve our service.</p>
            </div>
            ...
            {googleReviewUrl && (
              <div className="pt-4 border-t border-emerald-200">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 bg-white border border-stone-300 rounded-lg px-5 py-2.5 font-medium text-stone-800 hover:bg-stone-50 hover:border-stone-400 transition-colors shadow-sm"
                >
    ...
    <Card>
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            <label className="block text-sm font-medium text-stone-700 mb-1">
              Anything we could improve? <span className="text-stone-400 font-normal">(optional)</span>
            </label>
            <Textarea
          ...
          <div className="flex items-start gap-3 p-3 bg-stone-50 rounded-lg">
            ...
            />
            <label htmlFor="display-consent" className="text-sm text-stone-700">
              I&apos;m okay with my review being shared publicly (e.g., on the chef&apos;s website or social media).
              Your name and feedback may be displayed.
            </label>
          </div>
