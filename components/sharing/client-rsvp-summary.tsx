  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        ...
        <div className="text-center px-3 py-2 bg-stone-50 rounded-lg">
          <div className="text-xl font-bold text-stone-700">{summary.pending_count}</div>
      ...
      {originalGuestCount && (
        <div className="text-sm text-stone-600 bg-stone-50 px-4 py-2 rounded-lg">
        ...
        {guests.map((guest) => (
          <div key={guest.id} className="py-3 flex items-center justify-between">
            <div>
              ...
              {guest.email && (
                <div className="text-xs text-stone-500">{guest.email}</div>
              )}
              {guest.notes && (
