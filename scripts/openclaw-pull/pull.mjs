...
const SOURCE_TO_CHAIN = [
  ...
  // ── Expansion batch: additional chains ──
  [/^ic-amigos-/,                  'amigos'],
  [/^ic-apna-bazaar-/,             'apna_bazaar'],
  [/^ic-associated-/,              'associated'],
  [/^ic-balducci-/,                'balducci'],
  [/^ic-bi-lo-/,                   'bi_lo'],
  [/^ic-bravo-/,                   'bravo'],
  [/^ic-buehlers-/,                'buehlers'],
  [/^ic-c-town-/,                  'ctown'],
  [/^ic-central-co-op-/,           'central_coop'],
  [/^ic-chefs-warehouse-/,         'chefs_warehouse'],
  [/^ic-compare-foods-/,           'compare_foods'],
  [/^ic-county-market-/,           'county_market'],
  [/^ic-deciccos-/,                'deciccos'],
  [/^ic-dollar-tree-/,             'dollar_tree'],
  [/^ic-dorothy-lane-/,            'dorothy_lane'],
  [/^ic-el-ahorro-/,               'el_ahorro'],
  [/^ic-el-rancho-/,               'el_rancho'],
  [/^ic-erewhon-/,                 'erewhon'],
  [/^ic-fairway-/,                 'fairway'],
  [/^ic-family-dollar-/,           'family_dollar'],
  [/^ic-five-below-/,              'five_below'],
  [/^ic-food-depot-/,              'food_depot'],
  [/^ic-food-emporium-/,           'food_emporium'],
  [/^ic-food-town-/,               'food_town_tx'],
  [/^ic-foods-co-/,                'foods_co'],
  [/^ic-good-fortune-/,            'good_fortune'],
  [/^ic-great-wall-/,              'great_wall'],
  [/^ic-grocery-depot-/,           'grocery_depot'],
  [/^ic-hana-world-/,              'hana_world'],
  [/^ic-harmons-/,                 'harmons'],
  [/^ic-international-fresh-/,     'intl_fresh'],
  [/^ic-jetro-/,                   'jetro'],
  [/^ic-jons-/,                    'jons'],
  [/^ic-jungle-jims-/,             'jungle_jims'],
  [/^ic-kam-man-/,                 'kam_man'],
  [/^ic-karns-/,                   'karns'],
  [/^ic-kings-/,                   'kings_food'],
  [/^ic-kowalskis-/,               'kowalskis'],
  [/^ic-la-bodega-/,               'la_bodega'],
  [/^ic-la-michoacana-/,           'la_michoacana'],
  [/^ic-lazy-acres-/,              'lazy_acres'],
  [/^ic-lins-/,                    'lins'],
  [/^ic-lucky-supermarkets-/,      'lucky_ca'],
  [/^ic-lunds-byerlys-/,           'lunds_byerlys'],
  [/^ic-maceys-/,                  'maceys'],
  [/^ic-marc-/,                    'marcs'],
  [/^ic-market-32-/,               'market_32'],
  [/^ic-market-of-choice-/,        'market_of_choice'],
  [/^ic-market-street-/,           'market_street'],
  [/^ic-martins-super-/,           'martins_super'],
  [/^ic-metropolitan-market-/,     'metropolitan_market'],
  [/^ic-metro-market-/,            'metro_market'],
  [/^ic-mom-organic-/,             'mom_organic'],
  [/^ic-morton-williams-/,         'morton_williams'],
  [/^ic-nugget-markets-/,          'nugget_markets'],
  [/^ic-ocean-state-/,             'ocean_state'],
  [/^ic-ollies-/,                  'ollies'],
  [/^ic-owens-/,                   'owens'],
  [/^ic-pathmark-/,                'pathmark'],
  [/^ic-performance-food-/,        'performance_food'],
  [/^ic-presidente-/,              'presidente'],
  [/^ic-ranch-market-/,            'ranch_market'],
  [/^ic-redner-/,                  'redner'],
  [/^ic-ridleys-/,                 'ridleys'],
  [/^ic-rosauers-/,                'rosauers'],
  [/^ic-roundys-/,                 'roundys'],
  [/^ic-save-a-lot-/,              'save_a_lot'],
  [/^ic-sentry-/,                  'sentry'],
  [/^ic-sharp-shopper-/,           'sharp_shopper'],
  [/^ic-spartan-nash-/,            'spartan_nash'],
  [/^ic-spec-/,                    'specs'],
  [/^ic-super-1-foods-/,           'super_1_foods'],
  [/^ic-super-a-foods-/,           'super_a_foods'],
  [/^ic-super-king-/,              'super_king'],
  [/^ic-town-and-country-/,        'town_country'],
  [/^ic-uncle-giuseppes-/,         'uncle_giuseppes'],
  [/^ic-western-beef-/,            'western_beef'],
  [/^ic-westside-market-/,         'westside_market'],
  [/^ic-yokes-/,                   'yokes'],
