...
async function main() {
  ...
  console.log(`  Chef:         ${result.chefEmail}`)
  console.log(`  Chef pass:    ${result.chefPassword}`)
  console.log(`  Client:       ${result.clientEmail}`)
  console.log(`  Client pass:  ${result.clientPassword}`)
  console.log(`  Chef profile: /chef/${result.chefSlug}`)
