...
import foodPromotionModule from '../lib/openclaw/food-promotion'

const { buildFoodAliases, evaluateCanonicalFoodReadiness, normalizeFoodLookupKey } =
  foodPromotionModule as any

type CanonicalFoodReadinessInput = Parameters<typeof evaluateCanonicalFoodReadiness>[0]
