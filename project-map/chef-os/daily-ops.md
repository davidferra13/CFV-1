# Daily Operations and Briefing

**What:** Start-of-day intelligence and coordination. AI-generated daily plan, morning briefing, shift handoff.
...
- Instant Note Capture: `/capture`, the desktop dock, and mobile quick capture save unstructured raw notes first, queue background interpretation, route components to workflow notes, ingredients, tasks, and calendar entries when confidence is high, and keep medium/low-confidence or failed notes in a review queue with trace links and correction learning.
