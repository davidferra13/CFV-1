...
**What:** Team coordination for chefs with staff. Roster, tasks, stations, activity tracking.

**Routes:** `/staff`, `/tasks`, `/stations`, `/notifications`, `/staff/portal`, `/staff/live`
**Status:** DONE
...
- Notifications: real-time system, email, push, SMS with per-category toggles
