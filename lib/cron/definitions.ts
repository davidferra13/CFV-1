...
export const CRON_MONITOR_DEFINITIONS: CronMonitorDefinition[] = [
  ...
  {
    cronName: 'resolve-prices',
    routePath: '/api/cron/resolve-prices',
    maxExpectedMinutes: 2880,
    cadence: '6h',
    description: 'Pre-compute per-ingredient, per-region resolved prices for national coverage',
  },
  {
  ...
  {
    cronName: 'inventory-depletion',
    routePath: '/api/cron/inventory-depletion',
    maxExpectedMinutes: 2880,
    cadence: 'daily',
    description: 'Check ingredient stock levels and alert chefs on depletion',
  },
  {
    cronName: 'pre-event-reminders',
    routePath: '/api/cron/pre-event-reminders',
    maxExpectedMinutes: 2880,
    cadence: 'daily',
    description: 'Send T-14d, T-7d, T-2d, T-1d client reminders and T-2d dietary summary to chef',
  },
  {
    cronName: 'follow-up-sends',
    routePath: '/api/scheduled/follow-up-sends',
    maxExpectedMinutes: 2880,
    cadence: 'daily',
    description: 'Drain pending follow-up emails (post-event thank-yous, rebooking nudges)',
  },
  {
    cronName: 'recurring-events',
    routePath: '/api/cron/recurring-events',
    maxExpectedMinutes: 2880,
    cadence: 'daily',
    description: 'Auto-generate draft events from active recurring schedules',
  },
  {
    cronName: 'recurring-tasks',
    routePath: '/api/cron/recurring-tasks',
    maxExpectedMinutes: 2880,
    cadence: 'daily',
