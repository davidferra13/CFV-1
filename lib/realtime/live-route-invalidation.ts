...
const ENTITY_ROUTE_SEGMENTS: Record<string, string[]> = {
  ...
  chef_culinary_profile: ['settings', 'profile', 'public-profile', 'chef', 'culinary', 'remy'],
  chef_culinary_profiles: ['settings', 'profile', 'public-profile', 'chef', 'culinary', 'remy'],
  chef_preferences: ['settings', 'chef', 'features'],
  chef_profile: ['settings', 'chef', 'portfolio'],
  chef_profile_context: ['settings', 'profile', 'public-profile', 'chef', 'remy'],
  chef_profile_contexts: ['settings', 'profile', 'public-profile', 'chef', 'remy'],
  ...
  remy_memories: ['remy', 'settings', 'profile'],
  remy_memory: ['remy', 'settings', 'profile'],
  remy_profile_context: ['remy', 'settings', 'profile', 'public-profile', 'chef'],
  remy_profile_contexts: ['remy', 'settings', 'profile', 'public-profile', 'chef'],
