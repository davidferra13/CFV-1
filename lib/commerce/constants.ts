...
export const KDS_TICKET_STATUSES = ['new', 'in_progress', 'ready', 'served', 'voided'] as const
export type KDSTicketStatus = (typeof KDS_TICKET_STATUSES)[number]

export const KDS_TICKET_STATUS_LABELS: Record<KDSTicketStatus, string> = {
  new: 'New',
  in_progress: 'Cooking',
  ready: 'Ready',
  served: 'Served',
...
export const KDS_TICKET_STATUS_COLORS: Record<KDSTicketStatus, string> = {
  new: 'default',
  in_progress: 'warning',
  ready: 'success',
  served: 'info',
...
export const KDS_TICKET_PRIORITIES = ['normal', 'rush', 'vip'] as const
export type KDSTicketPriority = (typeof KDS_TICKET_PRIORITIES)[number]

export const KDS_PRIORITY_LABELS: Record<KDSTicketPriority, string> = {
  normal: 'Normal',
  rush: 'Rush',
  vip: 'VIP',
}

// Status transition map for bump functionality
export const KDS_STATUS_TRANSITIONS: Record<KDSTicketStatus, KDSTicketStatus | null> = {
  new: 'in_progress',
  in_progress: 'ready',
  ready: 'served',
  served: null,
