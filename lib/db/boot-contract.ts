...
export const DB_BOOT_CONTRACT_OBJECTS: readonly DbBootContractObject[] = [
  ...
  {
    id: 'public.chefs',
    description: 'Chef runtime table used by public discoverability and authenticated role resolution.',
    readinessRequired: true,
  ...
  },
  {
    ...
    description: 'Authoritative auth-to-entity role bridge used by public, auth, and admin runtimes.',
    readinessRequired: true,
  ...
  },
  {
    ...
    surfaces: {
      activeSchema: [
        {
          filePath: 'lib/db/schema/schema.ts',
          patterns: ['export const directoryListingFavorites = pgTable("directory_listing_favorites"'],
        },
      ],
      generatedSchema: [
        {
  ...
  },
  {
    ...
    surfaces: {
      sqlMigrations: [
        {
          filePath: 'database/migrations/20260422000003_price_intelligence_contract_and_governor.sql',
  ...
  },
  {
    ...
    description: 'Ingredient knowledge slug mapping table used by public ingredient detail lookups.',
    readinessRequired: true,
    ...
    surfaces: {
      activeSchema: [
        {
          filePath: 'lib/db/schema/schema.ts',
          patterns: ['export const ingredientKnowledgeSlugs = pgTable("ingredient_knowledge_slugs"'],
        },
      ],
      generatedSchema: [
        {
  ...
  },
  {
    ...
    description: 'Expression index supporting canonicalized directory state browse and geo filters.',
    readinessRequired: true,
    criticalMigrationFile: '20260422000030_public_boot_db_hardening.sql',
