...
export const RELEASE_GATE_WARNING_POLICIES = Object.freeze({
  ...
  next_server_actions_config: {
    id: 'next_server_actions_config',
    label: 'Next.js serverActions config warning',
    message:
      'Build emitted the known Next.js serverActions config warning. This is tracked until the config surface is retired or moved.',
    matcher: /serverActions.*unrecognized key/i,
    severity: RELEASE_GATE_WARNING_SEVERITY.TRACK,
  },
})
    ...
    full: Object.freeze({
      ...
      steps: Object.freeze([
        ...
        Object.freeze({
          ...
          classification: RELEASE_GATE_STEP_CLASSIFICATION.CONTRACT,
          gateSeverity: RELEASE_GATE_WARNING_SEVERITY.BLOCK,
          warningPolicyIds: Object.freeze(['dynamic_server_usage', 'next_server_actions_config']),
        }),
        Object.freeze({
