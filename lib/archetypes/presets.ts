...
export const ARCHETYPES: ArchetypeDefinition[] = [
  ...
  },
  {
    ...
    emoji: '🏪',
    enabledModules: [...ALWAYS_ON, 'culinary', 'clients'],
    primaryNavHrefs: [
      '/dashboard',
      '/inbox',
      '/staff',
    ...
    mobileTabHrefs: ['/dashboard', '/stations', '/staff', '/inbox', '/schedule'],
  },
  {
    id: 'food-truck',
    label: 'Food Truck',
    ...
    emoji: '🚚',
    enabledModules: [...ALWAYS_ON, 'culinary'],
    primaryNavHrefs: ['/dashboard', '/schedule', '/stations', '/tasks', '/travel', '/activity'],
    mobileTabHrefs: ['/dashboard', '/stations', '/schedule', '/travel', '/tasks'],
  },
  {
    id: 'bakery',
    label: 'Bakery / Pastry',
