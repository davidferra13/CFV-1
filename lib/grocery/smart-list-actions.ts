...
const AISLE_KEYWORDS: Record<AisleSection, string[]> = {
  produce: [
    ...
    'strawberry', 'raspberry', 'avocado', 'tomato', 'potato', 'onion', 'garlic',
    'ginger', 'carrot', 'celery', 'broccoli', 'cauliflower', 'spinach', 'kale',
    'lettuce', 'arugula', 'cabbage', 'pepper', 'cucumber', 'zucchini', 'squash',
    'mushroom', 'herb', 'basil', 'cilantro', 'parsley', 'mint', 'dill', 'thyme',
    'rosemary', 'scallion', 'shallot', 'leek', 'asparagus', 'artichoke', 'beet',
    'radish', 'turnip', 'sweet potato', 'corn', 'pea', 'green bean', 'mango',
    'pineapple', 'melon', 'watermelon', 'peach', 'pear', 'plum', 'fig',
    'pomegranate', 'kiwi', 'coconut', 'jalapeño', 'habanero', 'serrano',
    'fennel', 'chard', 'endive', 'watercress', 'sprout',
  ],
  meat_seafood: [
    'chicken', 'beef', 'pork', 'lamb', 'turkey', 'duck', 'veal', 'bison',
    'steak', 'ground beef', 'ground turkey', 'ground pork', 'bacon', 'sausage',
    'ham', 'ribs', 'tenderloin', 'brisket', 'roast', 'chop',
    'salmon', 'tuna', 'shrimp', 'prawn', 'crab', 'lobster', 'scallop',
    'cod', 'halibut', 'tilapia', 'trout', 'mahi', 'swordfish', 'bass',
    'clam', 'mussel', 'oyster', 'squid', 'calamari', 'octopus', 'anchovy',
    'sardine', 'fish', 'meat', 'seafood', 'poultry',
  ],
  dairy_eggs: [
    'milk', 'cream', 'half and half', 'butter', 'cheese', 'cheddar',
    'mozzarella', 'parmesan', 'gruyere', 'brie', 'gouda', 'feta',
    'ricotta', 'cream cheese', 'sour cream', 'yogurt', 'egg',
    'whipping cream', 'heavy cream', 'cottage cheese', 'mascarpone',
    'buttermilk', 'ghee', 'kefir',
  ],
  bakery: [
    'bread', 'baguette', 'roll', 'croissant', 'muffin', 'bagel',
    'pita', 'naan', 'tortilla', 'wrap', 'bun', 'sourdough', 'brioche',
    'focaccia', 'ciabatta', 'english muffin', 'cake', 'pie crust',
  ],
  frozen: [
    'frozen', 'ice cream', 'sorbet', 'gelato', 'popsicle', 'frozen pizza',
    'frozen vegetable', 'frozen fruit', 'frozen dinner', 'frozen fries',
    'frozen waffle', 'frozen pie',
  ],
  pantry_dry: [
    'pasta', 'spaghetti', 'penne', 'fusilli', 'linguine', 'fettuccine',
    'rice', 'quinoa', 'couscous', 'barley', 'oat', 'granola', 'cereal',
    'flour', 'sugar', 'brown sugar', 'powdered sugar', 'cornstarch',
    'breadcrumb', 'panko', 'cracker', 'chip', 'popcorn', 'pretzel',
    'nut', 'almond', 'walnut', 'pecan', 'cashew', 'peanut', 'pistachio',
    'dried fruit', 'raisin', 'date', 'lentil', 'bean', 'chickpea',
    'black bean', 'kidney bean', 'navy bean', 'split pea',
  ],
  canned: [
    'canned', 'tomato paste', 'tomato sauce', 'diced tomato', 'crushed tomato',
    'coconut milk', 'broth', 'stock', 'soup', 'tuna can', 'sardine can',
    'bean can', 'corn can', 'pumpkin puree', 'chipotle in adobo',
  ],
  condiments_sauces: [
    'ketchup', 'mustard', 'mayonnaise', 'mayo', 'hot sauce', 'soy sauce',
    'worcestershire', 'bbq sauce', 'salsa', 'sriracha', 'tabasco',
    'vinegar', 'balsamic', 'ranch', 'dressing', 'relish', 'horseradish',
    'teriyaki', 'hoisin', 'fish sauce', 'oyster sauce', 'tahini',
    'pesto', 'marinara', 'alfredo', 'jam', 'jelly', 'honey', 'maple syrup',
    'molasses', 'miso',
  ],
  spices: [
    'salt', 'pepper', 'cumin', 'paprika', 'chili powder', 'cayenne',
    'cinnamon', 'nutmeg', 'clove', 'allspice', 'cardamom', 'coriander',
    'turmeric', 'curry', 'oregano', 'bay leaf', 'sage', 'tarragon',
    'marjoram', 'saffron', 'star anise', 'five spice', 'garlic powder',
    'onion powder', 'smoked paprika', 'italian seasoning', 'everything bagel',
    'vanilla extract', 'vanilla', 'almond extract', 'seasoning',
  ],
  beverages: [
    'water', 'sparkling water', 'soda', 'juice', 'orange juice', 'apple juice',
    'coffee', 'tea', 'kombucha', 'lemonade', 'wine', 'beer', 'champagne',
    'prosecco', 'vodka', 'gin', 'rum', 'tequila', 'whiskey', 'bourbon',
    'brandy', 'vermouth', 'bitters', 'tonic', 'club soda', 'energy drink',
    'coconut water', 'oat milk', 'almond milk', 'soy milk',
  ],
  deli: [
    'deli', 'sliced turkey', 'sliced ham', 'salami', 'prosciutto',
    'pepperoni', 'pastrami', 'roast beef', 'mortadella', 'capicola',
    'hummus', 'prepared salad', 'rotisserie',
  ],
  bulk: [
    'bulk', 'grain', 'seed', 'flaxseed', 'chia seed', 'hemp seed',
    'sunflower seed', 'pumpkin seed', 'trail mix', 'dried bean',
  ],
  international: [
    'nori', 'seaweed', 'tofu', 'tempeh', 'edamame', 'wonton', 'dumpling',
    'rice noodle', 'udon', 'soba', 'ramen', 'kimchi', 'gochujang',
    'sambal', 'curry paste', 'coconut cream', 'tamarind', 'plantain',
    'jerk', 'harissa', 'za\'atar', 'sumac', 'tahini', 'halloumi',
    'paneer', 'ghee', 'chutney', 'naan', 'injera', 'mochi',
  ],
  baking: [
    'baking powder', 'baking soda', 'yeast', 'chocolate chip', 'cocoa',
    'chocolate', 'sprinkle', 'food coloring', 'gelatin', 'pectin',
    'parchment', 'cupcake liner', 'pie crust', 'puff pastry',
    'phyllo', 'fondant', 'marzipan', 'meringue powder',
    'cream of tartar', 'corn syrup', 'condensed milk', 'evaporated milk',
  ],
  snacks: [
    'snack', 'cookie', 'cracker', 'granola bar', 'protein bar',
    'fruit snack', 'dried mango', 'beef jerky', 'rice cake',
    'peanut butter', 'nutella',
  ],
  household: [
    'paper towel', 'napkin', 'plastic wrap', 'aluminum foil', 'foil',
    'parchment paper', 'zip bag', 'storage bag', 'trash bag', 'sponge',
    'dish soap', 'detergent', 'bleach', 'glove', 'toothpick',
    'skewer', 'candle', 'lighter', 'match',
  ],
  other: [],
}
...
export async function getSmartLists(status?: ListStatus) {
  ...
  return (data ?? []) as (SmartGroceryList & { smart_grocery_items: { id: string; is_checked: boolean }[] })[]
}
...
export async function getSmartList(listId: string) {
  ...
  if (data?.smart_grocery_items) {
    data.smart_grocery_items.sort((a: SmartGroceryItem, b: SmartGroceryItem) => a.sort_order - b.sort_order)
  }
...
export async function saveAislePreference(
  storeName: string,
  keyword: string,
  aisle: AisleSection
) {
