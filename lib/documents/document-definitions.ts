...
export const DOCUMENT_DEFINITIONS: Record<OperationalDocumentType, DocumentDefinition> = {
  ...
  plating: {
    type: 'plating',
    label: 'Plating Guide',
    docTypeLabel: 'Plating Guide',
    fallbackTitle: 'PLATING GUIDE',
    filenameBase: 'plating-guide',
    templateSlug: 'plating-guide',
    category: 'core',
    isCorePacket: false,
    requiredSignals: ['menu courses', 'dish names', 'component details'],
  },
  allergen: {
    type: 'allergen',
    label: 'Allergen Quick-Reference',
    docTypeLabel: 'Allergen Reference',
    fallbackTitle: 'ALLERGEN QUICK-REFERENCE',
    filenameBase: 'allergen-reference',
    templateSlug: 'allergen-reference',
    category: 'core',
    isCorePacket: false,
    requiredSignals: ['guest dietary info', 'allergy data'],
  },
  venue: {
    type: 'venue',
    label: 'Venue/Kitchen Recon',
    docTypeLabel: 'Venue Recon',
    fallbackTitle: 'VENUE / KITCHEN RECON',
    filenameBase: 'venue-recon',
    templateSlug: 'venue-recon',
    category: 'core',
    isCorePacket: false,
    requiredSignals: ['venue location', 'kitchen layout'],
  },
  beverage: {
    type: 'beverage',
    label: 'Beverage & Pairing Notes',
    docTypeLabel: 'Beverage Notes',
    fallbackTitle: 'BEVERAGE & PAIRING NOTES',
    filenameBase: 'beverage-notes',
    templateSlug: 'beverage-notes',
    category: 'core',
    isCorePacket: false,
    requiredSignals: ['menu courses', 'pairing context'],
  },
  contact: {
    type: 'contact',
    label: 'Client Contact & Access',
    docTypeLabel: 'Contact Sheet',
    fallbackTitle: 'CLIENT CONTACT & ACCESS',
    filenameBase: 'client-contact',
    templateSlug: 'client-contact',
    category: 'core',
    isCorePacket: false,
    requiredSignals: ['client info', 'venue access'],
  },
  mise: {
    type: 'mise',
    label: 'Mise en Place Verification',
    docTypeLabel: 'Mise Check',
    fallbackTitle: 'MISE EN PLACE VERIFICATION',
    filenameBase: 'mise-check',
    templateSlug: 'mise-check',
    category: 'core',
    isCorePacket: false,
    requiredSignals: ['prep tasks', 'component details', 'quantities'],
  },
}
