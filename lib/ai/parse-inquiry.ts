...
const ParsedInquirySchema = z.object({
  parsed: z.object({
    ...
    discussed_dishes: z.array(z.string()).default([]),
...
- Discussed dishes: extract specific dish names, recipes, or menu items the client mentions (e.g., "Paneer Tikka", "Caesar Salad", "Beef Wellington"). Use the exact names the client uses. Do not invent dishes.
...
Output: { "parsed": { "client_name": "Mark Chen", "client_email": "mark.chen@email.com", "client_phone": "617-555-0199", "channel": "email", "confirmed_date": "2026-08-23", "confirmed_guest_count": 12, "confirmed_location": "Brookline", "confirmed_occasion": "Dinner party", "confirmed_budget_cents": 240000, "confirmed_dietary_restrictions": ["vegan (2 guests)", "nut allergy (1 guest)"], "confirmed_service_expectations": "Plated, 4-course", "confirmed_cannabis_preference": null, "discussed_dishes": [], "source_message": null, "notes": "Found through Take a Chef", "referral_source": "take_a_chef" }, "confidence": "high", "warnings": [] }
...
Output: { "parsed": { "client_name": "Elisa Perel", "client_email": null, "client_phone": "508-737-2766", "channel": "email", "confirmed_date": null, "confirmed_guest_count": 2, "confirmed_location": "Naples, Maine", "confirmed_occasion": "Mini-moon dinner, surprise for fiance", "confirmed_budget_cents": null, "confirmed_dietary_restrictions": [], "confirmed_service_expectations": "Private dinner", "confirmed_cannabis_preference": "Cannabis meal for 1 guest, regular meal for other", "discussed_dishes": [], "source_message": null, "notes": "Staying Sept 18-20 at Airbnb in Naples, ME. Host referral. Flexible on which night.", "referral_source": "airbnb_host" }, "confidence": "high", "warnings": ["No specific date chosen - 3 possible dates mentioned"] }
