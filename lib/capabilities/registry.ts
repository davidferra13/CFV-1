...
const SHELL_PROFILES: Record<ChefFlowShellArea, ShellProfile> = {
  ...
  "Orders / Reservations": { leaders: ["Toast", "Clover", "OpenTable", "Deliverect"], best: ["real-time order state", "reservation pacing", "delivery-channel aggregation"], pain: ["orders and reservations live in separate systems", "marketplaces create duplicate menus and tablets"], apps: ["Toast", "Clover", "OpenTable", "Uber Eats", "DoorDash"], evidence: ["lib/commerce", "lib/booking", "lib/restaurant", "lib/tickets"], sources: [SOURCES.pos, SOURCES.delivery] },
...
const seeds: Seed[] = [
  ...
  { id: "orders-pos", capability: "POS order lifecycle", shell: "Orders / Reservations", job: "Take, route, modify, fire, settle, and close orders from ChefFlow", strategy: "INTEGRATE", priority: "P0", frequency: "CONTINUOUS", operations: SERVICE_OPS, build: "MISSING", apps: ["Toast", "Clover", "Square"] },
  { id: "orders-reservations", capability: "Reservations, waitlist, table, and pacing management", shell: "Orders / Reservations", job: "Manage booking through seating and service pacing without opening a reservation system", strategy: "INTEGRATE", priority: "P0", frequency: "CONTINUOUS", operations: SERVICE_OPS, build: "MISSING", apps: ["OpenTable", "SevenRooms", "Resy"] },
  { id: "orders-delivery", capability: "Delivery channel aggregation", shell: "Orders / Reservations", job: "Receive and manage delivery orders from every channel in one normalized queue", strategy: "AGGREGATE", priority: "P0", frequency: "CONTINUOUS", operations: SERVICE_OPS, build: "MISSING", apps: ["DoorDash", "Uber Eats", "Grubhub", "Deliverect"] },
