...
const BookingSettingsSchema = z.object({
  ...
  booking_slug:              z.string()
    ...
    .regex(/^[a-z0-9][a-z0-9-]*[a-z0-9]$/, 'Slug: lowercase letters, numbers, and hyphens only (no leading/trailing hyphen)')
    .optional()
    .or(z.literal('')),
...
export async function getPublicBookingConfig(chefSlug: string): Promise<PublicBookingConfig | null> {
