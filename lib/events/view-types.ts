/**
 * Event lifecycle action-layer types and resolvers.
 * Each resolver takes domain-specific candidate data and produces a
 * SurfaceActionTask variant for the dashboard action surface.
 */
