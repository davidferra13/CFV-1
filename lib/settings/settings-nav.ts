    ...
    items: [
      {
        ...
        icon: 'Building2',
        description: 'Business defaults, services, event config, and print settings',
      },
      {
        label: 'Scheduling',
        href: '/settings/scheduling',
        icon: 'CalendarDays',
        description: 'Availability rules and booking page',
      },
      {
        label: 'Payments',
        href: '/settings/payments',
        icon: 'CreditCard',
        description: 'Payments, payouts, and support options',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        icon: 'Palette',
        description: 'Profile, appearance, professional growth, and chef network',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        icon: 'MessageSquare',
        description: 'Communication workflows, notifications, and alerts',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        icon: 'Link2',
        description: 'Connected accounts, client reviews, and local AI',
      },
      {
        label: 'AI & Privacy',
        href: '/settings/ai',
        icon: 'Brain',
        description: 'AI preferences, data privacy, and export controls',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        icon: 'Shield',
        description: 'Contracts, insurance, and certifications',
      },
      {
        label: 'System & Account',
        href: '/settings/system',
        icon: 'Settings2',
        description: 'Sample data, desktop app, feedback, and account security',
      },
      {
        label: 'Developer',
