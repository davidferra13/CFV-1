...
export const API_SCOPES = {
  ...
  'commerce:read': 'View products, sales, registers, and POS data',
  'commerce:write': 'Create and manage products, sales, and POS operations',
  'marketing:read': 'View campaigns, templates, and marketing data',
  'marketing:write': 'Create and manage campaigns and sequences',
  'loyalty:read': 'View loyalty config, rewards, and points',
  'loyalty:write': 'Manage loyalty config, rewards, and points',
  'booking:read': 'View booking page settings',
  'booking:write': 'Update booking page settings',
  'partners:read': 'List and view referral partners',
  'partners:write': 'Create, update, and delete partners',
  'safety:read': 'List and view safety incidents',
