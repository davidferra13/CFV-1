...
export function isDirectoryListingIndexable(
  ...
  if (listing.status === 'verified') {
    return (
      hasLocation &&
      detailSignals >= 3 &&
      (updatedDays == null || updatedDays <= VERIFIED_INDEX_MAX_AGE_DAYS)
    )
  }
...
function buildHoursTrust(
  ...
  if (listing.status === 'verified') {
    return {
      ...
      tone: 'verified',
      evidence:
        'Hours appear on an owner-verified listing. Field-level edit tracking is not available yet.',
    }
  }
  ...
  if (listing.status === 'claimed') {
    return {
      ...
      tone: 'claimed',
      evidence:
        'Owner claimed this listing, but we do not know whether these hours were updated after claim.',
    }
  }
...
function buildPhotosTrust(listing: DirectoryListingTrustInput, now: Date): DirectoryFieldTrust {
  ...
  if (listing.status === 'verified') {
    return {
      ...
      tone: 'verified',
      evidence:
        'Photos appear on an owner-verified listing. Per-photo source tracking is not available yet.',
    }
  }
  ...
  if (listing.status === 'claimed') {
    return {
      ...
      tone: 'claimed',
      evidence:
        'Owner claimed this listing, but we do not track whether each photo was added by the owner or came from public sources.',
    }
  }
...
function buildMenuTrust(
  ...
  if (listing.status === 'verified') {
    return {
      ...
      tone: 'verified',
      evidence:
        'Menu link appears on an owner-verified listing. Field-level edit tracking is not available yet.',
    }
  }
  ...
  if (listing.status === 'claimed') {
    return {
      ...
      tone: 'claimed',
      evidence:
        'Owner claimed this listing, but we do not know whether the menu link was updated after claim.',
    }
  }
...
function buildContactTrust(
  ...
  if (listing.status === 'verified') {
    return {
      ...
      tone: 'verified',
      evidence:
        'Contact info appears on an owner-verified listing. We do not track each contact field separately.',
    }
  }
  ...
  if (listing.status === 'claimed') {
    return {
      ...
      tone: 'claimed',
      evidence:
        'Owner claimed this listing, but some contact fields may still reflect public data.',
    }
  }
