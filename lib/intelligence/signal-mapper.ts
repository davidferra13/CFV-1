...
const SOURCE_ACTION_MAP: Record<string, Omit<MappedSignalAction, 'signalType' | 'urgencyIcon'>> = {
  'clients.dormant': {
    category: 'client',
    title: 'Client Gone Quiet',
    description:
      'This client has not booked in a while. A check-in could reignite the relationship.',
