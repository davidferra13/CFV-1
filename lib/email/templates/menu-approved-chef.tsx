...
export function MenuApprovedChefEmail({
  chefName,
  clientName,
  occasion,
  eventDate,
  ...
  return (
    <BaseLayout brand={brand} preview={`${clientName} approved the menu for ${occasion}`}>
      ...
      <Text style={muted}>The menu is locked in. You can start prepping with confidence.</Text>
    </BaseLayout>
  )
}
