  ...
  return (
    <BaseLayout preview={`${chefName} sent you a proposal for ${occasion}`}>
      ...
      <Text style={paragraph}>
        {chefName} has sent you a complete proposal for your{' '}
        <strong>{occasion}</strong> on <strong>{eventDate}</strong>.
      </Text>
      <Text style={paragraph}>
      ...
      <Text style={muted}>
        This link takes you to a secure page where you can review everything and take
        the next steps at your own pace.
      </Text>
    </BaseLayout>
  )
}
