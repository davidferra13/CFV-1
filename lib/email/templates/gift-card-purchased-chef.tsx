...
export function GiftCardPurchasedChefEmail({
  ...
  return (
    <BaseLayout preview={`${amountFormatted} gift card sold`}>
      ...
      <table style={detailsTable}>
        <tbody>
          ...
          <tr>
            ...
            <td style={{ ...detailValue, fontFamily: 'monospace', letterSpacing: '0.1em' }}>{code}</td>
          </tr>
        </tbody>
      </table>

      <Text style={paragraph}>
        The gift card has been delivered to the recipient. When they&apos;re ready to book, they&apos;ll
        apply the code at checkout.
      </Text>

      <Text style={muted}>
        You can manage gift cards from the Financials section.
      </Text>
    </BaseLayout>
  )
}
