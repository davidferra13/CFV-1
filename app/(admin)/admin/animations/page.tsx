        ...
        <div className="grid grid-cols-3 sm:grid-cols-4 gap-2">
          {HOLIDAY_CONFIGS.map((h) => (
            <button
              ...
              type="button"
              onClick={() => trigger(h)}
              className="flex items-center gap-2 px-3 py-2 bg-white border border-slate-200 rounded-lg text-sm text-left hover:bg-blue-50 hover:border-blue-300 transition-colors"
            >
            ...
            <div className="grid grid-cols-3 sm:grid-cols-4 gap-2">
              {items.map((def) => (
                <button
                  ...
                  className="flex items-center gap-2 px-3 py-2 bg-white border border-slate-200 rounded-lg text-sm text-left hover:bg-emerald-50 hover:border-emerald-300 transition-colors"
                >
