...
export const metadata: Metadata = { title: 'Approved Menus - ChefFlow' }
...
export default async function ApprovedMenusPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <Link href="/culinary/menus" className="text-sm text-stone-500 hover:text-stone-700">
          ← All Menus
        </Link>
        <div className="flex items-center gap-3 mt-1">
          <h1 className="text-3xl font-bold text-stone-900">Approved Menus</h1>
      ...
      {menus.length === 0 ? (
        <Card className="p-12 text-center">
          <p className="text-stone-600 font-medium mb-1">No approved menus yet</p>
          <p className="text-stone-400 text-sm mb-4">
            Menus move here once a client approves them and they are locked
          </p>
          <Link href="/culinary/menus">
            <Button variant="secondary" size="sm">View All Menus</Button>
          </Link>
        </Card>
      ) : (
        <Card>
