    ...
    <div className="space-y-6">
      <div>
        ...
        <div className="flex items-center gap-3 mt-1">
          ...
          <span className="bg-orange-100 text-orange-700 text-sm px-2 py-0.5 rounded-full">{sauces.length}</span>
        </div>
      ...
      {sauces.length > 0 && (
        <div className="grid grid-cols-3 gap-4">
          ...
          <Card className="p-4">
            <p className="text-2xl font-bold text-amber-700">{sauces.filter(c => c.is_make_ahead).length}</p>
