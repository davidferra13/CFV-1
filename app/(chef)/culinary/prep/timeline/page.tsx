        ...
        <div className="flex items-start justify-between gap-3">
          <div>
            ...
            <p className="text-sm text-amber-700 mt-1">
              Components marked as make-ahead on a menu appear here, grouped by menu and sorted
              from longest to shortest lead time. Use this to build your day-by-day prep schedule
              working backwards from the event date.
            </p>
          </div>
