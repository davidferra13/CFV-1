...
export function BusinessSectionMobileContent(
  ...
  const metricWidgets: MetricWidget[] = [
    ...
    },
    {
      ...
      href: '/inventory',
      rows: [
        { label: 'Stocked Items', value: toInteger(stockSummary.totalItems) },
        { label: 'Expired Batches', value: toInteger(expiredInventoryAlerts.length) },
        { label: 'Below Par', value: toInteger(stockSummary.belowParCount) },
