        ...
        {fetchFailures.length > 0 && (
          <div className="rounded-lg border border-amber-800 bg-amber-950 px-4 py-3">
            ...
            <p className="text-xs text-amber-400 mt-1">
              ...
              to load. The affected sections may show incomplete information. Try refreshing the
              page.
            </p>
          </div>
        )}
                      ...
                      {!revenueGoal.enabled ? (
                        <>
                          ...
                          <p className="text-sm text-stone-500 mt-1">
                            Enable revenue goals in Settings to get booking and calendar
                            suggestions.
                          </p>
                        </>
                      ) : (
                        ...
                        <Card>
                          ...
                          <CardContent>
                            ...
                            {seasonality.upcomingPeak &&
                              seasonality.upcomingPeak.monthsAway <= 3 && (
                              ...
                              seasonality.upcomingQuiet.monthsAway <= 3 && (
                                <div className="mb-3 flex items-center gap-2 rounded-md bg-stone-800 border border-stone-700 px-3 py-2">
                                  ...
                                  <p className="text-xs text-stone-300">
                                    ...
                                    ({seasonality.upcomingQuiet.monthName}) — good time to take on
                                    new clients
                                  </p>
                                </div>
                              )}
