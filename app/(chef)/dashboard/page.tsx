...
import { SourcingPhoneButton } from '@/components/dashboard/sourcing-phone-button'
...
export default async function ChefDashboard() {
  ...
  return (
    <div className="space-y-10">
      {/* Sourcing phone FAB - always visible, like the phone app */}
      <SourcingPhoneButton />
      ...
      <DashboardSection id="this-week" title="This Week">
        <div className="space-y-6">
          ...
          {/* Recipe Gaps - upcoming events with undocumented dishes */}
          {!isMinimalDensity &&
            (bypassProgressiveDisclosure || !presence || presence.hasEvents) && (
