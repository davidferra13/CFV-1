  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8 space-y-6">
      ...
      <div>
        ...
        <h1 className="text-2xl font-bold text-stone-900">Template Library</h1>
        <p className="mt-1 text-sm text-stone-500">
          Pre-built starters and your own saved templates. Pick one in the campaign builder to pre-fill the form.
        </p>
      </div>
      ...
      {systemTemplates.length > 0 && (
        <div className="space-y-2">
          <h2 className="text-xs font-semibold text-stone-400 uppercase tracking-wide">Starter Templates</h2>
                ...
                <div className="flex items-start justify-between gap-3">
                  <div className="min-w-0">
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      <Badge variant="default">{CAMPAIGN_TYPE_LABELS[t.campaign_type] ?? t.campaign_type}</Badge>
                    ...
                    <pre className="whitespace-pre-wrap text-xs text-stone-400 mt-2 max-h-16 overflow-hidden line-clamp-3">
                      {t.body_html.slice(0, 200)}{t.body_html.length > 200 ? '…' : ''}
                    </pre>
                  </div>
                </div>
              </CardContent>
      ...
      {ownTemplates.length > 0 && (
        <div className="space-y-2">
          <h2 className="text-xs font-semibold text-stone-400 uppercase tracking-wide">Your Templates</h2>
      ...
      {ownTemplates.length === 0 && (
        <p className="text-sm text-stone-500">
          No custom templates yet. You can save any sent campaign as a template from its detail page.
        </p>
      )}
