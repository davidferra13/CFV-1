    ...
    <div className="space-y-6">
      <div>
        ...
        <div className="flex items-center gap-3 mt-1">
          <h1 className="text-3xl font-bold text-stone-900">Converted</h1>
          <span className="bg-green-100 text-green-700 text-sm px-2 py-0.5 rounded-full">
            {inquiries.length}
          </span>
        </div>
        <p className="text-stone-500 mt-1">Website leads that became paying clients — confirmed events</p>
      </div>

      {inquiries.length === 0 ? (
        <Card className="p-12 text-center">
          <p className="text-stone-600 font-medium mb-1">No converted leads yet</p>
          <p className="text-stone-400 text-sm">Leads move here once they confirm and an event is created</p>
        </Card>
      ) : (
        <>
          <Card className="p-4">
