...
const VIEWS = [
  { href: '/finance/payouts/stripe-payouts', label: 'Stripe Payouts', icon: '💳', description: 'Automated payouts via Stripe Connect' },
  { href: '/finance/payouts/manual-payments', label: 'Manual Payments', icon: '💵', description: 'Cash, Venmo, Zelle, and other offline payments' },
  { href: '/finance/payouts/reconciliation', label: 'Reconciliation', icon: '⚖️', description: 'Compare events vs recorded ledger payments' },
]
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h1 className="text-3xl font-bold text-stone-900 mt-1">Payouts</h1>
        <p className="text-stone-500 mt-1">How you actually receive your money — Stripe automatic transfers and manual offline payments</p>
      </div>
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <Card className="p-4">
          <p className="text-2xl font-bold text-stone-900">{formatCurrency(summary.netRevenueCents)}</p>
