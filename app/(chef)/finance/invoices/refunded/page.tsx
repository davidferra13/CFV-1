    ...
    <div className="space-y-6">
      <div>
        ...
        <div className="flex items-center gap-3 mt-1">
          <h1 className="text-3xl font-bold text-stone-900">Refunded Invoices</h1>
          <span className="bg-purple-100 text-purple-700 text-sm px-2 py-0.5 rounded-full">{refunded.length}</span>
        </div>
      ...
      {refunded.length === 0 ? (
        <Card className="p-12 text-center">
          <p className="text-stone-600 font-medium">No refunded invoices</p>
