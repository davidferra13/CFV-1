  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h1 className="text-3xl font-bold text-stone-900 mt-1">Quarterly Estimates</h1>
        <p className="text-stone-500 mt-1">Estimated quarterly tax payments based on your year-to-date income and expenses</p>
      </div>
      ...
      {summary ? (
        ...
        <div className="rounded-lg border border-stone-200 bg-stone-50 p-8 text-center">
          <p className="text-stone-500 text-sm">Tax summary data is not available for {currentYear}.</p>
        </div>
      )}
    </div>
  )
