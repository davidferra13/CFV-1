    ...
    <div className="space-y-6">
      <div>
        ...
        <div className="flex items-center gap-3 mt-1">
          <h1 className="text-3xl font-bold text-stone-900">Revenue Summary</h1>
          <span className="bg-stone-100 text-stone-600 text-sm px-2 py-0.5 rounded-full">{revenueEvents.length} events</span>
        </div>
      ...
      {revenueEvents.length === 0 ? (
        <Card className="p-12 text-center">
          <p className="text-stone-600 font-medium">No revenue events yet</p>
          <p className="text-stone-400 text-sm mt-1">Revenue appears here once events are accepted or completed</p>
        </Card>
      ) : (
        <Card>
          <Table>
            ...
            <TableBody>
              {revenueEvents.map(event => (
                <TableRow key={event.id}>
                  ...
                  <TableCell className="font-semibold text-stone-900 text-sm">
