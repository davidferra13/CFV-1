  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h1 className="text-3xl font-bold text-stone-900 mt-1">Recurring Invoices</h1>
        <p className="text-stone-500 mt-1">Manage automated invoices for retainer clients and recurring services</p>
      </div>
