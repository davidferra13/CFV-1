...
export const metadata: Metadata = { title: 'Expense by Category' }
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h1 className="text-3xl font-bold text-stone-100 mt-1">Expense by Category</h1>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <Card className="p-4">
          <p className="text-2xl font-bold text-stone-100">{categoryTotals.size}</p>
      ...
      {groupData.length === 0 ? (
        <Card className="p-12 text-center">
          <p className="text-stone-400 font-medium">No expenses recorded</p>
        </Card>
      ) : (
                    ...
                    {group.categories
                      ...
                      .map((cat) => (
                        <TableRow key={cat.value}>
                          ...
                          <TableCell className="text-stone-400 text-sm">{cat.count}</TableCell>
