...
const REPORTS = [
  ...
  { href: '/finance/reporting/revenue-by-month', label: 'Revenue by Month', icon: '📅', description: '12-month rolling revenue trend — export CSV' },
  { href: '/finance/reporting/revenue-by-event', label: 'Revenue by Event', icon: '🍽️', description: 'All events ranked by invoice value' },
  { href: '/finance/reporting/revenue-by-client', label: 'Revenue by Client', icon: '👤', description: 'Lifetime value and revenue per client — export CSV' },
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <Card className="p-4">
          <p className="text-2xl font-bold text-stone-900">{ytdEvents}</p>
          <p className="text-sm text-stone-500 mt-1">Events this year</p>
        </Card>
        <Card className="p-4">
          <p className="text-2xl font-bold text-stone-900">{formatCurrency(monthExpenses)}</p>
      ...
      {conversionData && (
        <Card className="p-5">
          <h2 className="font-semibold text-stone-900 mb-4">Pipeline Conversion Funnel</h2>
