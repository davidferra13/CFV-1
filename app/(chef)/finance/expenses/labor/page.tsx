    ...
    <div className="space-y-6">
      <div>
        ...
        <div className="flex items-center gap-3 mt-1">
          <h1 className="text-3xl font-bold text-stone-900">Labor</h1>
          <span className="bg-orange-100 text-orange-700 text-sm px-2 py-0.5 rounded-full">{expenses.length}</span>
        </div>
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <Card className="p-4">
          <p className="text-2xl font-bold text-stone-600">{eventLinked}</p>
      ...
      {expenses.length === 0 ? (
        <Card className="p-12 text-center">
          <p className="text-stone-600 font-medium">No labor expenses recorded</p>
        </Card>
      ) : (
        <Card>
          <Table>
