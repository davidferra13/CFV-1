  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h1 className="text-3xl font-bold text-stone-900 mt-1">Expenses</h1>
        <p className="text-stone-500 mt-1">All business and event-related expenses, organized by category</p>
      </div>
          ...
          <Link key={section.href} href={section.href}>
            <Card className="p-5 hover:shadow-md transition-shadow cursor-pointer h-full">
              <div className="flex items-start justify-between">
                ...
                <span className="text-xs bg-stone-100 text-stone-600 px-2 py-0.5 rounded-full">{section.count}</span>
              </div>
