    ...
    <div className="space-y-6">
      <div>
        ...
        <div className="flex items-center gap-3 mt-1">
          <h1 className="text-3xl font-bold text-stone-900">Rentals &amp; Equipment</h1>
          <span className="bg-stone-200 text-stone-700 text-sm px-2 py-0.5 rounded-full">{expenses.length}</span>
        </div>
      ...
      {expenses.length === 0 ? (
        <Card className="p-12 text-center">
          <p className="text-stone-600 font-medium">No rentals or equipment expenses recorded</p>
        </Card>
      ) : (
        <Card>
          <Table>
