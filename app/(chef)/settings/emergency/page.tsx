...
export default async function EmergencyPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8 space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-stone-900">Emergency Contacts</h1>
        <p className="mt-1 text-sm text-stone-500">
          People to call if you are unable to execute an event — a sous chef you trust,
          a business partner, or a peer chef who can step in.
        </p>
      </div>

      <div className="rounded-lg border border-blue-200 bg-blue-50 px-4 py-3">
        <p className="text-sm text-blue-900">
          These contacts are private and only visible to you. They appear as options when
          you add contingency plans to specific events.
        </p>
      </div>
