...
export const metadata: Metadata = { title: 'NDA & Permissions' }
...
export default async function NdaPermissionsPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8 space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-stone-100">NDA &amp; Photo Permissions</h1>
        ...
        <CardContent className="pt-6 space-y-4">
          <div className="flex items-start gap-3">
            ...
            <div className="space-y-2">
              <p className="text-sm font-medium text-stone-100">Per-client settings</p>
