    ...
    <div className="max-w-2xl space-y-6">
      <div>
        <div className="flex items-center gap-3 mb-1">
          <Link href="/loyalty" className="text-sm text-stone-500 hover:text-stone-700">
            ← Loyalty Dashboard
          </Link>
        </div>
        <h1 className="text-3xl font-bold text-stone-900">Program Settings</h1>
        <p className="text-stone-600 mt-1">
          Configure how clients earn points, which milestones they hit, and what tiers mean.
