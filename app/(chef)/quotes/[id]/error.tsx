...
export default function QuoteDetailError({
  ...
  useEffect(() => {
    reportClientBoundaryError(error, { boundary: 'quote-detail', digest: error.digest })
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[400px] gap-4">
      ...
      <p className="text-sm text-muted-foreground">Could not load this quote.</p>
      {error.digest && (
        <CopyableErrorId
          digest={error.digest}
      ...
      <ErrorReportButton error={error} boundary="quote-detail" />
    </div>
  )
}
