...
export default function QuotesError({
  ...
  useEffect(() => {
    reportClientBoundaryError(error, { boundary: 'quotes', digest: error.digest })
    console.error('[Quotes Error]', error)
  }, [error])

  return (
    <div className="flex flex-col items-center justify-center min-h-[400px] gap-4">
      <h2 className="text-xl font-semibold">Could not load quotes</h2>
      ...
      <ErrorReportButton error={error} boundary="quotes" />
    </div>
  )
}
