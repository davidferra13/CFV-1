...
export default function InquiriesError({
  ...
  useEffect(() => {
    reportClientBoundaryError(error, { boundary: 'inquiries', digest: error.digest })
    console.error('[Inquiries Error]', error)
  }, [error])

  return (
    <div className="flex flex-col items-center justify-center min-h-[400px] gap-4">
      <h2 className="text-xl font-semibold">Could not load inquiries</h2>
      ...
      <ErrorReportButton error={error} boundary="inquiries" />
    </div>
  )
}
