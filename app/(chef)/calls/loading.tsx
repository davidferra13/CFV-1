    ...
    <div className="max-w-4xl mx-auto px-4 py-8 space-y-6 animate-pulse">
      ...
      <div className="flex items-center justify-between">
        <div className="space-y-2">
          <div className="h-7 w-44 bg-stone-200 rounded" />
      ...
      <div className="flex gap-2">
        {['Upcoming', 'Completed', 'All'].map(tab => (
          <div key={tab} className="h-8 w-24 bg-stone-200 rounded-full" />
        ))}
      </div>
      ...
      <div className="space-y-3">
        {[1, 2, 3, 4].map(i => (
          <div key={i} className="rounded-xl border border-stone-200 bg-white p-4 flex items-center gap-4">
            {/* Avatar */}
            ...
            {/* Badge */}
            <div className="h-6 w-20 bg-stone-200 rounded-full flex-shrink-0" />
            {/* Time */}
