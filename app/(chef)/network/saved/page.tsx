  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-2">
        ...
        <h1 className="text-2xl font-bold text-stone-900">Saved Posts</h1>
      </div>
      ...
      {posts.length === 0 ? (
        <div className="bg-white rounded-2xl border border-stone-200 p-12 text-center">
          ...
          <p className="text-stone-400 text-xs mt-1">Tap the bookmark icon on any post to save it here</p>
          <Link href="/network" className="text-amber-700 text-sm font-medium hover:underline mt-3 block">
            Browse the feed →
          </Link>
        </div>
      ) : (
