        ...
        <CardContent>
          {dailyReport.length === 0 ? (
            <div className="text-center py-6">
              ...
              <p className="text-sm text-stone-400 font-medium">No sales in this period</p>
              <p className="text-xs text-stone-600 mt-1">
                Sales data will populate as transactions are recorded
              </p>
            </div>
          ) : (
        ...
        <CardContent>
          {productReport.length === 0 ? (
            <div className="text-center py-6">
              ...
              <p className="text-sm text-stone-400 font-medium">No product data</p>
              <p className="text-xs text-stone-600 mt-1">
                Product performance will show after sales are recorded
              </p>
            </div>
          ) : (
            <div className="space-y-2">
