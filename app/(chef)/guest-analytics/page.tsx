...
export default async function GuestAnalyticsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-stone-900">Guest Insights</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <Card className="p-4 text-center">
          <p className="text-3xl font-bold text-stone-900">{stats.totalUniqueGuests}</p>
      ...
      {/* Repeat guests */}
      <Card className="p-4">
        <h2 className="font-semibold text-stone-900 mb-3">Repeat Guests</h2>
      ...
      {/* Dinner groups */}
      <Card className="p-4">
        <h2 className="font-semibold text-stone-900 mb-1">Dinner Groups</h2>
            ...
            {dinnerGroups.map((group, i) => (
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-stone-700">{group.guests.join(' & ')}</span>
                </div>
