...
export const metadata: Metadata = { title: 'Completed Events - ChefFlow' }
    ...
    <div className="space-y-6">
      <div>
        ...
        <div className="flex items-center gap-3 mt-1">
          <h1 className="text-3xl font-bold text-stone-900">Completed Events</h1>
          <span className="bg-stone-100 text-stone-600 text-sm px-2 py-0.5 rounded-full">
            {events.length}
          </span>
        </div>
        <p className="text-stone-500 mt-1">Successfully completed and closed events</p>
      </div>

      {events.length === 0 ? (
        <Card className="p-12 text-center">
          <p className="text-stone-600 font-medium mb-1">No completed events</p>
          <p className="text-stone-400 text-sm mb-4">Your completed events will appear here</p>
          <Link href="/events">
