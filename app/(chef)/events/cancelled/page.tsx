    ...
    <div className="space-y-6">
      <div>
        ...
        <div className="flex items-center gap-3 mt-1">
          <h1 className="text-3xl font-bold text-stone-100">Cancelled Events</h1>
      ...
      {events.length === 0 ? (
        <Card className="p-12 text-center">
          <p className="text-stone-400 font-medium mb-1">No cancelled events</p>
          <p className="text-stone-400 text-sm mb-4">
            Cancelled events will appear here for your records
          </p>
          <Link href="/events">
