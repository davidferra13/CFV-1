    ...
    <div className="space-y-6">
      <div>
        ...
        <div className="flex items-center gap-3 mt-1">
          <h1 className="text-3xl font-bold text-stone-900">Cancelled Events</h1>
          <span className="bg-stone-100 text-stone-600 text-sm px-2 py-0.5 rounded-full">
            {events.length}
          </span>
        </div>
        <p className="text-stone-500 mt-1">Events that were cancelled</p>
      </div>

      {events.length === 0 ? (
        <Card className="p-12 text-center">
          <p className="text-stone-600 font-medium mb-1">No cancelled events</p>
          <p className="text-stone-400 text-sm mb-4">Cancelled events will appear here for your records</p>
          <Link href="/events">
