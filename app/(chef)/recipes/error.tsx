...
export default function RecipesError({
  ...
  useEffect(() => {
    Sentry.captureException(error, {
      tags: { boundary: 'recipes', digest: error.digest },
    })
    ...
    <div className="max-w-md mx-auto mt-20 px-4">
      <Card>
        <CardHeader className="text-center">
          <CardTitle className="text-xl">Recipes error</CardTitle>
          <p className="text-sm text-stone-400 mt-1">Something went wrong loading your recipes.</p>
        </CardHeader>
