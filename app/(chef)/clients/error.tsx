...
export default function ClientsError({
  ...
  useEffect(() => {
    reportClientBoundaryError(error, { boundary: 'clients', digest: error.digest })
    console.error('[Clients Error]', error)
  }, [error])

  return (
    <div className="flex flex-col items-center justify-center min-h-[400px] gap-4">
      <h2 className="text-xl font-semibold">Could not load clients</h2>
      ...
      <ErrorReportButton error={error} boundary="clients" />
    </div>
  )
}
