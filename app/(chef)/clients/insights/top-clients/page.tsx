...
export const metadata: Metadata = { title: 'Top Clients - ChefFlow' }
    ...
    <div className="space-y-6">
      <div>
        ...
        <div className="flex items-center gap-3 mt-1">
          <h1 className="text-3xl font-bold text-stone-900">Top Clients</h1>
      ...
      {ranked.length === 0 ? (
        <Card className="p-12 text-center">
          <p className="text-stone-600 font-medium mb-1">No revenue data yet</p>
          <p className="text-stone-400 text-sm">Top clients will appear here once payments are recorded</p>
        </Card>
      ) : (
        <Card>
          <Table>
              ...
              {ranked.map((client, i) => {
                ...
                return (
                  <TableRow key={client.id}>
                    ...
                    <TableCell className="text-stone-600 text-sm">{sharePercent}%</TableCell>
