    ...
    <div className="space-y-6">
      ...
      {atRisk.length === 0 ? (
        <Card className="p-12 text-center">
          <p className="text-stone-400 font-medium mb-1">No at-risk clients</p>
          <p className="text-stone-400 text-sm">
            All active clients have booked within the past 90 days
          </p>
        </Card>
      ) : (
        <Card>
              ...
              {atRisk.map((client: any) => {
                ...
                return (
                  <TableRow key={client.id}>
                    ...
                    <TableCell className={`text-sm ${urgencyClass}`}>{days} days ago</TableCell>
                    <TableCell className="text-stone-400 text-sm">
