  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h1 className="text-2xl font-bold text-stone-100 mt-1">Guest Retention</h1>
      ...
      <div className="flex gap-3">
        <Link href="/leads" className="text-sm text-brand-500 hover:text-brand-400 font-medium">
          Guest Pipeline
        </Link>
      </div>
    </div>
