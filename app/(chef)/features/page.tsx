...
const SECTIONS: Section[] = [
  {
    ...
    features: [
      ...
      },
      {
        label: 'Marketplace',
        href: '/marketplace',
        description: 'Broadcast your open dates to clients looking for a chef.',
        icon: Radio,
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        label: 'Consulting',
        href: '/consulting',
        description: 'Manage consulting engagements and retainer clients.',
        icon: Briefcase,
      },
    ],
  },
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        href: '/intelligence',
        description: 'Deep business intelligence: benchmarks, trends, and insights.',
        icon: Lightbulb,
      },
      {
        label: 'Brand Mentions',
        href: '/reputation/mentions',
        description: 'Track where your name appears across the web.',
        icon: Megaphone,
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description: 'Central sourcing hub: vendors, quotes, and order tracking.',
        icon: ShoppingCart,
      },
      {
        label: 'Physical Audits',
        href: '/inventory/audits',
        description: 'Guided stocktake with variance reporting.',
        icon: ListChecks,
      },
      {
        label: 'Waste Tracking',
        href: '/inventory/waste',
        description: 'Log and analyze food waste to cut costs.',
        icon: Trash2,
      },
    ],
  },
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description: 'Add your own data fields to events and clients.',
        icon: Sliders,
      },
      {
        label: 'Keyboard Shortcuts',
        href: '/commands',
        description: 'Speed up your workflow with quick commands.',
        icon: Keyboard,
      },
    ],
  },
