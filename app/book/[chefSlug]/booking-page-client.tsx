  ...
  if (config.bookingModel === 'instant_book') {
    return [
      ...
      },
      {
        ...
        detail: 'Checkout is hosted securely by Stripe and reserves the date inside the current booking flow.',
      },
    ]
  }
      ...
      <div className="space-y-6">
        <section className="rounded-[28px] border border-stone-700 bg-stone-900/90 p-6 shadow-[var(--shadow-card)]">
          <div className="flex flex-wrap gap-2">
            ...
            <StepPill step={isInstantBook ? '3. Secure booking' : '3. Submit request'} active={Boolean(selectedDate)} />
          </div>
