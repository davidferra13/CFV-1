...
import { buildPublicMarketScopeNote, resolvePublicMarketScope } from '@/lib/public/public-market-scope'
import {
      ...
      {seasonalContext && (
        <div className="rounded-2xl border border-stone-700 bg-stone-900/60 p-5 sm:p-6">
          ...
          <p className="mt-2 text-xs leading-5 text-stone-500">
            {effectiveScope ? buildPublicMarketScopeNote(effectiveScope) : seasonalContext.summary.scopeNote}
          </p>
        </div>
      )}
