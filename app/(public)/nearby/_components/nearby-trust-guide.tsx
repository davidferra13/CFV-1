...
const TRUST_STATE_ITEMS = [
  ...
  },
  {
    key: 'claimed',
    label: 'Claimed',
    description: 'The business took over the listing, but some fields may still reflect older public data.',
  },
  {
    key: 'discovered',
    label: 'Discovered',
    description: 'Public-source-only listing. Good for discovery, but key details can need confirmation.',
  },
] as const
