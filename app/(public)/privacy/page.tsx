    ...
    <main className="mx-auto w-full max-w-4xl px-4 py-12 sm:px-6 md:py-16 lg:px-8">
      ...
      <div className="space-y-10 text-stone-700">
        ...
        <section>
          ...
          <p className="mt-4 leading-relaxed">
            Each provider is contractually required to protect your information and use it only for
            the purpose of delivering their services to us.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="leading-relaxed">
            ...
            subscription, your data remains accessible to you for 30 days, after which it may be
            archived or deleted at our discretion. Event records and financial ledger entries are
            retained for a minimum of seven years to comply with standard accounting practices. You
            may request earlier deletion of non-financial personal data (see Section 6).
          </p>
        </section>
