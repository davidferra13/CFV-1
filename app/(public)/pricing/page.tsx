    ...
    <main>
      ...
      <section className="border-b border-stone-800/50">
        <div className="mx-auto w-full max-w-5xl px-4 pb-10 pt-20 sm:px-6 md:pb-14 md:pt-28 lg:px-8">
          ...
          <p className="mt-5 max-w-3xl text-base leading-relaxed text-stone-300 md:text-lg">
            ...
            operator workflows are free today, the current $29/month charge is a voluntary
            supporter contribution, and a larger paid surface is still only classified or planned.
          </p>
      ...
      <section className="mx-auto grid w-full max-w-5xl gap-6 px-4 pb-12 sm:px-6 md:grid-cols-2 lg:px-8">
        ...
        <div className="rounded-3xl border border-brand-700/30 bg-gradient-to-b from-brand-950/20 to-stone-900 p-6">
          ...
          <h2 className="mt-3 text-2xl font-display text-stone-100">Core workflows are free today</h2>
          ...
          <div className="mt-6 rounded-2xl border border-stone-800/70 bg-stone-950/70 p-4">
            ...
            <p className="mt-2 text-sm leading-relaxed text-stone-400">
              ${PRO_PRICE_MONTHLY}/month, billed through Stripe if a chef chooses to support
              ongoing development. Public terms say this does not unlock additional features today.
            </p>
          </div>
        ...
        <div className="mx-auto w-full max-w-5xl px-4 py-12 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 text-sm leading-relaxed text-stone-400">
              This list comes directly from the current feature classification map. Count: {freeCount}
              .
            </p>
          </div>
          <div className="mt-8">
        ...
        <div className="mx-auto w-full max-w-5xl px-4 py-12 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 text-sm leading-relaxed text-stone-400">
              ...
              classified future paid unless ChefFlow republishes a narrower live entitlement promise.
            </p>
          </div>
