  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-stone-50 to-white">
      <div className="max-w-2xl mx-auto px-4 py-8 sm:py-12">
        ...
        {eventData.menus.length > 0 && (
          <Card className="mb-8">
            <CardContent className="p-6">
              <h2 className="text-xl font-semibold text-stone-900 mb-4 text-center">The Menu</h2>
              <div className="space-y-3">
                {eventData.menus.map((menu: any) => (
                  <div key={menu.id} className="text-center">
                    <h3 className="font-medium text-stone-900">{menu.name}</h3>
                    {menu.description && (
        ...
        {photos.length > 0 && (
          <div className="mb-8">
            <h2 className="text-xl font-semibold text-stone-900 mb-4 text-center">Moments</h2>
        ...
        {eventData.chefProfileUrl && (
          <div className="text-center py-8 border-t border-stone-200">
            <p className="text-stone-600 mb-4">Want to host your own private dining experience?</p>
            <a
