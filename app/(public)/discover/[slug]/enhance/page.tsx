...
// Pre-filled form for businesses that claimed their listing.
// Allows them to add photos, description, hours, menu link, etc.
// Linked from the "claimed" confirmation email.
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: `Complete Your Profile - ${listing.name} | ChefFlow`,
    robots: { index: false },
  }
}
...
export default async function EnhanceProfilePage({ params }: Props) {
  ...
  // Only allow enhancement for claimed or verified listings
