...
export const metadata: Metadata = {
  title: 'Add Your Business - ChefFlow Directory',
  description:
    'Submit your restaurant, catering business, food truck, bakery, or private chef service to the ChefFlow directory. Free listing, no commission.',
}
    ...
    <div className="min-h-screen bg-stone-950">
      ...
      <div className="mx-auto max-w-2xl px-4 py-12 sm:px-6">
        ...
        <p className="mt-2 text-sm text-stone-400">
          List your restaurant, catering business, food truck, bakery, or private chef service in
          the ChefFlow directory. Your listing is free and links directly to your website. No
          middleman, no commission.
        </p>
