    ...
    <main>
      <section className="mx-auto w-full max-w-4xl px-4 pt-20 pb-8 sm:px-6 md:pt-28 md:pb-12 lg:px-8">
        ...
        <p className="mt-4 max-w-3xl text-base leading-relaxed text-stone-300">
          ChefFlow does not use one generic booking path. You can browse the current directory, send
          an open request to matched chefs, or contact a specific chef directly. Some chefs may also
          offer instant booking with a Stripe deposit.
        </p>
      </section>
