  ...
  return (
    <div className="flex items-center gap-2.5 rounded-lg bg-stone-50 px-3 py-2">
      {partner.cover_image_url ? (
        ...
        <div className="flex h-8 w-8 items-center justify-center rounded-md bg-stone-200 flex-shrink-0">
          <svg
      ...
      <span className="flex-shrink-0 rounded-full bg-stone-200/70 px-2 py-0.5 text-[10px] font-medium text-stone-500">
...
function ChefTile({ chef }: { chef: DirectoryChef }) {
  ...
  return (
    <article className="group relative flex flex-col overflow-hidden rounded-2xl bg-white shadow-[0_2px_20px_rgb(0,0,0,0.06)] ring-1 ring-stone-100 transition-all duration-300 hover:shadow-[0_8px_40px_rgb(0,0,0,0.10)] hover:ring-brand-200 hover:-translate-y-1">
      ...
      <div className="flex flex-1 flex-col p-5">
        {/* Bio */}
        {chef.bio && (
          <p className="text-sm leading-relaxed text-stone-600 line-clamp-2">{chef.bio}</p>
        )}
