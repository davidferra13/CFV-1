      ...
      <section className="border-y border-stone-700/50 bg-stone-900/40">
        <div className="mx-auto w-full max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 text-sm leading-relaxed text-stone-300">
              ChefFlow has different public booking paths, but the trust posture is the same:
              review the written terms before paying, use the chef contact path first, and use
              support for escalation when the issue is bigger than routine planning.
            </p>
          </div>
        ...
        <div className="mx-auto w-full max-w-5xl px-4 py-14 sm:px-6 md:py-20 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-4 text-xs text-stone-500">
              ...
              <Link href="/how-it-works" className="font-medium text-brand-400 hover:text-brand-300">
