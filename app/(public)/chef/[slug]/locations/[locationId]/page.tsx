...
export default async function PublicLocationPage({ params }: Props) {
  ...
  const bookingHref = location.booking_url ? `/chef/${publicSlug}/locations/${location.id}/book` : null
          ...
          <div className="mt-6 grid gap-6 lg:grid-cols-[1.2fr,0.8fr]">
            <div>
              ...
              <div className="mt-6 flex flex-wrap gap-2">
                ...
                <DetailChip label={`${location.images.length} photo${location.images.length === 1 ? '' : 's'}`} />
              </div>
            </div>
