...
function buildInquiryDestination(request: NextRequest, slug: string, partnerId: string, locationId: string) {
...
export async function GET(
  ...
  if (!resolvedPartner || resolvedPartner.status !== 'active' || resolvedPartner.is_showcase_visible === false) {
