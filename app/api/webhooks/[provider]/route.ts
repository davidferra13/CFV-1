...
import { createIntegrationEventFromWebhook, processIntegrationEvent } from '@/lib/integrations/core/pipeline'
...
export async function POST(
  ...
  const secret = req.nextUrl.searchParams.get('secret') || req.headers.get('x-chefflow-webhook-secret')
  if (!secret) {
