...
export default async function ClientQuotesPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-stone-900">My Quotes</h1>
        <p className="text-stone-600 mt-1">Review and respond to pricing quotes from your chef</p>
      </div>
                ...
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <p className="text-sm text-stone-500 mt-1">
                      Received {formatDistanceToNow(new Date(quote.sent_at || quote.created_at), { addSuffix: true })}
                    </p>
                  </div>
      ...
      {pendingQuotes.length === 0 && resolvedQuotes.length === 0 && (
        <Card className="p-8 text-center">
          <p className="text-stone-500">No quotes yet. Your chef will send you quotes when ready.</p>
        </Card>
      )}
