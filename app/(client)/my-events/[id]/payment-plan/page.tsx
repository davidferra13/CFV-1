...
export default async function PaymentPlanPage({
  ...
  let eventResult: { id: string; quoted_price_cents: number | null; event_date: string; occasion: string | null } | null = null
  try {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div>
        <h1 className="text-2xl sm:text-3xl font-bold text-stone-900">Payment Plan</h1>
