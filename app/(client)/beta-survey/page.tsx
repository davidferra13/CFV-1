// Client Portal Beta Survey Page
// Shows the active beta survey for authenticated clients.
...
export default async function ClientBetaSurveyPage() {
  await requireClient()
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <div className="bg-stone-900 border border-stone-800 rounded-xl p-6">
        <BetaSurveyForm survey={survey} mode="authenticated" redirectTo="/my-events" />
      </div>
    </div>
  )
}
