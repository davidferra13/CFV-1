...
CREATE INDEX IF NOT EXISTS idx_contract_templates_chef ON contract_templates(chef_id);
...
CREATE INDEX IF NOT EXISTS idx_event_contracts_chef     ON event_contracts(chef_id, status);
CREATE INDEX IF NOT EXISTS idx_event_contracts_client   ON event_contracts(client_id);
...
-- Auto-update updated_at
DROP TRIGGER IF EXISTS trg_event_contracts_updated_at ON event_contracts;
DROP TRIGGER IF EXISTS trg_event_contracts_updated_at ON event_contracts;
...
DROP TRIGGER IF EXISTS trg_event_contracts_immutable ON event_contracts;
DROP TRIGGER IF EXISTS trg_event_contracts_immutable ON event_contracts;
