...
DROP POLICY IF EXISTS kr_chef_select ON kitchen_rentals;
...
DROP POLICY IF EXISTS kr_chef_insert ON kitchen_rentals;
...
DROP POLICY IF EXISTS kr_chef_update ON kitchen_rentals;
...
DROP POLICY IF EXISTS kr_chef_delete ON kitchen_rentals;
