...
ALTER TABLE chefs DROP CONSTRAINT IF EXISTS chefs_booking_slug_format;
ALTER TABLE chefs
...
ALTER TABLE chefs DROP CONSTRAINT IF EXISTS chefs_booking_deposit_pct_range;
ALTER TABLE chefs
...
ALTER TABLE chefs DROP CONSTRAINT IF EXISTS chefs_booking_min_notice_range;
ALTER TABLE chefs
