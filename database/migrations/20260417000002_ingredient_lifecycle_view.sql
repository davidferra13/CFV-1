-- Migration: Ingredient Quantity Lifecycle View
-- Consolidated view showing the full ingredient chain per event:
-- recipe_qty -> buy_qty (yield-adjusted) -> purchased -> used -> leftover
