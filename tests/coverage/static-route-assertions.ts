...
export async function assertRolePageLoads(
  page: Page,
  url: string,
  options: AssertRouteLoadsOptions
) {
  const { role, storageStatePath, missingStateMessage, requireStorageState = false } = options
