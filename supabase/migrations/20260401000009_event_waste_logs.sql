...
-- Indexes
CREATE INDEX idx_event_waste_logs_tenant ON event_waste_logs(tenant_id);
CREATE INDEX idx_event_waste_logs_event ON event_waste_logs(event_id);
CREATE INDEX idx_event_waste_logs_logged_at ON event_waste_logs(logged_at);
