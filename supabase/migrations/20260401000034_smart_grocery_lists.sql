...
CREATE INDEX idx_smart_grocery_lists_chef_id ON smart_grocery_lists(chef_id);
CREATE INDEX idx_smart_grocery_lists_event_id ON smart_grocery_lists(event_id) WHERE event_id IS NOT NULL;
...
CREATE INDEX idx_smart_grocery_items_list_id ON smart_grocery_items(list_id);
...
CREATE INDEX idx_aisle_preferences_chef_id ON aisle_preferences(chef_id);
