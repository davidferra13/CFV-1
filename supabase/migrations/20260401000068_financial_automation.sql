...
CREATE INDEX idx_event_milestones_event ON event_payment_milestones(event_id);
CREATE INDEX idx_event_milestones_status ON event_payment_milestones(status) WHERE status IN ('pending', 'reminded', 'overdue');
