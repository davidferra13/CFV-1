...
CREATE INDEX idx_wholesale_orders_delivery ON wholesale_orders (tenant_id, delivery_date);
...
CREATE INDEX idx_bakery_tastings_date ON bakery_tastings (tenant_id, tasting_date);
...
CREATE INDEX idx_bakery_seasonal_items_dates ON bakery_seasonal_items (tenant_id, start_date, end_date);
