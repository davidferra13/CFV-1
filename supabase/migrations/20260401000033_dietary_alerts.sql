...
CREATE TABLE IF NOT EXISTS dietary_change_log (
...
CREATE INDEX IF NOT EXISTS idx_dietary_change_log_chef_ack
  ON dietary_change_log (chef_id, acknowledged, created_at DESC);

-- Trend queries: recent changes by type
CREATE INDEX IF NOT EXISTS idx_dietary_change_log_chef_type
  ON dietary_change_log (chef_id, change_type, created_at DESC);

-- Client timeline
CREATE INDEX IF NOT EXISTS idx_dietary_change_log_client
...
DROP POLICY IF EXISTS dietary_change_log_chef_select ON dietary_change_log;
...
DROP POLICY IF EXISTS dietary_change_log_chef_insert ON dietary_change_log;
...
DROP POLICY IF EXISTS dietary_change_log_chef_update ON dietary_change_log;
...
DROP POLICY IF EXISTS dietary_change_log_chef_delete ON dietary_change_log;
